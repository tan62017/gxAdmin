...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/canvas-render-gx',
      name: 'canvas-render-gx',
      component: () => import('@/views/CanvasRenderGx/index.vue'),
      redirect: 'canvas-render-gx/index',
      children: [
        {
          path: '/canvas-render-gx/index',
          name: 'canvas-render-gx-index',
          component: () => import('@/views/CanvasRenderGx/Map/index.vue'),
        },
      ],
    },
    {
      path: '/canvas-test',
      name: 'canvas-test',
      component: () => import('@/views/TestEchart/index.vue'),
      // redirect: "canvas-render-gx/index",
      // children: [
      //   {
      //     path: "/canvas-render-gx/index",
