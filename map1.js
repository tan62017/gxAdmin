(function (config) {
  ...
  function pa() {
    ...
    return 0 <= a.indexOf("nvidia") ||
      ...
      ? ((b = ["nVidia"]),
        ...
        (c = a.match(na)) &&
          c[1] &&
          b.push(c[1].toUpperCase().replace("GS", "")),
        0 <= a.indexOf("titan")
          ? b.push("TITAN")
  ...
  var ra =
      "microsoft basic render driver;vmware svga 3d;Intel 965GM;Intel B43;Intel G41;Intel G45;Intel G965;Intel GMA 3600;Intel Mobile 4;Intel Mobile 45;Intel Mobile 965".split(
        ";"
      ),
    sa = "ActiveXObject" in ca,
    va =
      ("devicePixelRatio" in ca && 1 < ca.devicePixelRatio) ||
      (sa &&
        "matchMedia" in ca &&
        ca.matchMedia("(min-resolution:144dpi)") &&
        ca.matchMedia("(min-resolution:144dpi)").matches),
    wa = ma("windows nt"),
  ...
  var Wa = Ta ? "android" : Ma ? "ios" : wa ? "windows" : Ea ? "mac" : "other",
    Xa = sa && !ca.XMLHttpRequest,
    Ya = sa && !fa.querySelector,
    Za = sa && !fa.addEventListener,
    $a = sa && ma("msie 9"),
    ab = sa && ma("msie 10"),
    bb = sa && ma("rv:11"),
    cb = Za || $a,
    ...
    mb =
      chrome &&
      !lb &&
      (30 < parseInt(ba.split("chrome/")[1]) ||
        30 < parseInt(ba.split("crios/")[1])),
    nb = ma("firefox"),
    ob = nb && 27 < parseInt(ba.split("firefox/")[1]),
    pb = (Ea || Ma) && ma("safari") && ma("version/"),
    qb = Ea && pb && 7 < parseInt(ba.split("version/")[1]),
    rb = Ma && ma("aliapp"),
    sb = Ma && ((!jb && !fb && !ib && !chrome && !nb && !pb) || (rb && !fb)),
    tb = Ta || Ma || Da || ma("mobile"),
    ub = "ontouchstart" in fa,
    vb =
      ca.navigator &&
      ca.navigator.msPointerEnabled &&
      !!ca.navigator.msMaxTouchPoints,
    wb = ca.navigator && !!ca.navigator.maxTouchPoints,
    xb = !ub && (wb || vb),
    yb = ub || xb,
    zb = (function () {
      if (!tb) return ca.devicePixelRatio || 1;
    ...
    Ab = va && (!tb || (!!zb && 1 <= zb)),
    Bb = sa && "transition" in ga.style,
    Cb =
      !!fa.createElementNS &&
      !!fa.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
    Db = fa.createElement("canvas"),
    Eb = !(!Db || !Db.getContext),
    ...
    qa = "",
    Kb = 0,
    Lb = window.forceWebGL
      ? { alpha: !0, antialias: !0, depth: !0 }
      : {
          alpha: !0,
          antialias: !0,
          depth: !0,
    ...
    Mb = (function () {
      ...
      for (
        ...
        if (b) {
          if (
            b.drawingBufferWidth !== Db.width ||
            b.drawingBufferHeight !== Db.height
          )
            break;
          if (window.forceWebGL) return (Jb = a[c]), (Kb = Infinity), !0;
    ...
    Ob =
      ...
      za,
    Pb = !Ob && !Nb,
    Qb = Nb ? "vw" : Ob ? "d" : Pb ? "dv" : "v",
    Rb = ma("webkit"),
    Sb = "WebKitCSSMatrix" in ca && "m11" in new window.WebKitCSSMatrix(),
    Tb = "MozPerspective" in ga.style,
    Ub = "OTransition" in ga.style,
    Vb = Bb || Sb || Tb || Ub,
    Wb = void 0 !== config[8] ? config[8] : !0,
    Xb = void 0 !== config[9] ? config[9] : !0,
    Yb = void 0 !== config[10] ? config[10] : !0,
    Zb = void 0 !== config[11] ? config[11] : !0,
    $b = void 0 !== config[12] ? config[12] : null,
    ac = !Cb && tb && Eb,
    bc = !0;
  try {
    if ("undefined" === typeof ca.localStorage) bc = !1;
    else {
  ...
  var ec = parseInt(ba.split("chrome/")[1]),
    fc = Wb && Eb;
  config.l = {
    $ra: Ga,
    asa: La,
  ...
  window.AMap
    ? ((window.AMap.version = "1718085179880"),
      (window.AMap.xL = {
        yM: function (a) {
          a(gc);
        },
  ...
  gc.Tu = hc;
  for (
    var ic = document.head || document.getElementsByTagName("head")[0],
      jc =
      ...
      kc = null,
      lc = 0,
      mc = ic.childNodes.length;
    lc < mc;
    lc++
  )
    if (1 === ic.childNodes[lc].nodeType) {
      kc = ic.childNodes[lc];
      break;
    }
  if (jc)
    ...
    if (!a.lva)
      if (b && (b.innerLayer || b.innerOverlay)) a.B5 = !0;
        ...
        if (c) {
          ...
          for (var d in b)
            b.hasOwnProperty(d) &&
              ("Map" === c && d in oc ? g.BA.np(c, d, b[d]) : g.BA.np(c, d));
        }
      }
  };
  g.da = function () {};
  g.da.extend = g.da.extend = function (a) {
    ...
    function c() {
      ...
      if (!d && this.Ni) {
        ...
        this.Ni = this.Ni.replace(
          /url\((['"]?)(?:\.\.\/)*/g,
          "url($1" + g.o.Hb + "/"
        );
        a.styleSheet
          ? (a.styleSheet.cssText = this.Ni)
          : (a.innerHTML = this.Ni);
        for (
  ...
  g.BA = {
    ...
    send: function () {
      ...
      for (b in this.Gj)
        if (this.Gj.hasOwnProperty(b)) {
          var c = this.Gj[b],
            ...
            e;
          for (e in c)
            c.hasOwnProperty(e) && 0 == c[e] && (d.push(e), (c[e] = 1));
      ...
      a.length &&
        ...
        (a = g.o.Cc + "://webapi.amap.com/count?" + a.join("&")),
        new g.kb.Ab(a));
    },
  };
  ...
  g.va = {
    h: function (a, b, c, d, e) {
      ...
      f[a] = f[a] || [];
      e
        ? f[a].unshift({ yb: b, cf: c || this, Dj: d })
        : f[a].push({ yb: b, cf: c || this, Dj: d });
      return this;
    },
    we: function (a, b, c) {
      var d = this.nf;
    ...
    r: function (a, b) {
      ...
      void 0 !== b &&
        (b instanceof Array
          ...
          ? (c.value = b)
          : (c = g.extend(c, b)));
      for (var d = [].concat(this.nf[a]), e = 0; e < d.length; e += 1)
        d[e].yb &&
          (d[e].yb.call(d[e].cf || this, c),
          d[e] && d[e].Dj && this.nf[a] && this.nf[a].splice(e, 1));
      return this;
    },
    ui: function (a) {
  ...
  g.$e = {
    ...
    yl: function (a) {
      this.Il &&
        this.Il[a] &&
        (this.Il[a].G(a, "mv", this), (this.Il[a] = void 0));
    },
    zl: function () {
      if (this.Il)
  ...
  g.o = {
    ...
    key: "42ee35775cc64a4ae1784043c610d940",
    Cc: "http",
  ...
  function pc(a) {
    ...
    "https" === b &&
      ((g.o.mAa = "wss"),
      (g.o.fd = g.o.fd.replace("http", "https")),
      (g.o.QD = g.o.QD.replace("http", "https")),
      (g.o.VJ = g.o.VJ.replace("http", "https")),
      (g.o.BU = g.o.BU.replace("http", "https")),
      (g.o.RK = g.o.RK.replace("http", "https")),
      (g.o.SK = g.o.SK.replace("http", "https")),
      (g.o.VE = g.o.VE.replace("http", "https")),
      (g.o.zL = g.o.zL.replace("http", "https")),
      (g.o.UI = g.o.UI.replace("http", "https")));
    var c = window.location.href;
    0 !== c.indexOf("http") &&
      window.parent &&
      window.parent !== window &&
      (c = window.parent.location.href);
    ...
    d.type = "text/css";
    g.o.Ioa =
      "url(" + b + "://webapi.amap.com/theme/v1.3/openhand.cur),default";
    var e =
      ".amap-container{cursor:" +
      g.o.Ioa +
      ";}.amap-drag{cursor:url(" +
      b +
    ...
    window._AMapSecurityConfig &&
      (window._AMapSecurityConfig.securityJsCode
        ? ((g.o.Xa = window._AMapSecurityConfig.securityJsCode), (g.o.fv = ""))
        : window._AMapSecurityConfig.serviceHost &&
          ((g.o.fv = window._AMapSecurityConfig.serviceHost),
          (g.o.fd = g.o.fv),
          (b = ""),
          (b =
            (b =
              "https" === g.o.fd.split(":")[0]
                ? g.o.fd.replace(/https:\/\/\S+?\//g, "")
                : g.o.fd.replace(/http:\/\/\S+?\//g, "")) && b.split("/")[0]),
          (c = window.location.hostname),
          "_AMapService" !== b &&
            ("127.0.0.1" === c || "localhost" === c
              ? window.alert(
        ...
        for (var a = window.localStorage.length; 0 <= a; a -= 1) {
          ...
          if (b && "_AMap_" === b.slice(0, 6)) {
            var c = window.localStorage.getItem(b),
              c = JSON.parse(c || {});
            "_AMap_anole" === b
              ? c.version !== g.l.mf && window.localStorage.removeItem(b)
              : "_AMap_data.tileKeys" === b
              ? (c.vdataVer === g.l.mf && c.apiVer === g.o.Fk) ||
                window.localStorage.removeItem(b)
              : c.version !== g.o.Fk && window.localStorage.removeItem(b);
          }
        }
    } catch (d) {}
  }
  window.AMap && window.AMap.xL && window.AMap.xL.yM && window.AMap.xL.yM(pc);
  g.Nm = { Ru: Math.PI / 180, qwa: 180 / Math.PI, SQ: 6378137 };
  (function () {
    function a(a) {
      ...
      lra: function (b) {
        ...
        if (g.l.ba) {
          ...
          d.push(
            "&ios=" +
              encodeURIComponent(
                "viewMap?sourceApplication=jsapi_q&dev=0&poiname=" +
                  b.name +
                  "&lat=" +
                  b.y +
                  "&lon=" +
      ...
      z4: function (b) {
        ...
        if (g.l.ba) {
          ...
          d.push(
            "&ios=" +
              encodeURIComponent(
                "multiPointShow?sourceApplication=jsapi_p&dev=0&q=" +
                  [b.y, b.x, b.name, b.address, b.id].join() +
                  "&title=" +
                  b.name
              )
          );
      ...
      x4: function (b) {
        if (g.l.ba) {
          ...
          c.push(
            "&android=" +
              encodeURIComponent(
                "androidamap?action=openFeature&featureName=PoiDetail&poiid=" +
                  b.id +
                  "&poiname=" +
                  b.name +
                  "&x=" +
      ...
      NR: function (b) {
        ...
        if (g.l.ba) {
          ...
          d.push(
            "&ios=" +
              encodeURIComponent(
                "path?sourceApplication=jsapi_r_" +
                  b.t +
                  "&dev=0&slat=" +
                  b.sy +
                  "&slon=" +
                  ...
                  "&t=" +
                  b.t +
                  "&vian=0&vialons=&vialats=&vianames="
              )
          );
          var e = b.t;
          0 === b.t ? (e = 2) : 2 === b.t && (e = 4);
          d.push(
            "&android=" +
              encodeURIComponent(
                "androidamap://route?sourceApplication=jsapi_r_" +
                  b.t +
                  "&slat=" +
                  b.sy +
                  "&slon=" +
            ...
            "&mo=" +
              encodeURIComponent(
                g.o.Mv +
                  "/?r=" +
                  c.join(",") +
                  "&callapp=0&sourceApplication=jsapi_r_" +
                  b.t
              )
          );
          return d.join("");
  ...
  g.a = {
    ...
    lR: {
      ...
      stop: function (a) {
        a.noa = new Date() - a.startTime;
        this.cancel(a);
        a.lR = Math.round(1e3 / (a.noa / (a.mt.length + 1)));
      },
    },
    K4: function (a, b, c) {
      var d =
    ...
    eb: function (a) {
      if ("object" === typeof a && null !== a) {
        if (a.b7 || this.kk(a, "Float32Array") || this.kk(a, "Uint16Array"))
          return a;
    ...
    vxa: function (a, b) {
      for (
        var c = 1,
          c = 512 < b.length ? Math.round(Math.pow(b.length, 0.5)) : b.length,
          d = Math.ceil(b.length / c),
          e = 0;
        e < d;
        e += 1
      ) {
    ...
    am: function (a) {
      ...
      if (0 == a.indexOf("#")) {
        ...
        if (9 == a.length)
          return (a = a.substr(1)), this.Zk(a.substr(6) + a.substr(0, 6));
      } else {
        if (0 == a.indexOf("rgb(")) return (a = this.ixa(a)), a.push(1), a;
    ...
    NP: function (a, b, c, d, e, f, h) {
      ...
      f.push(a);
      h.push(k);
      (d ? this.qma : this.Dma)(a, function (d, e) {
        k[e] = g.a.NP(d, b, c, e, a, f, h);
      });
      return k;
    },
    yma: function (a, b) {
      return null == b ? a : this.Bma(b, Object.keys(b), a);
    },
    T5: function (a) {
      var b = typeof a;
    ...
    usa: function (a) {
      ...
      b &&
        "string" == typeof a[0] &&
        Object.hasOwnProperty.call(a, "index") &&
    ...
    Dma: function (a, b) {
      return g.a.ooa()(a, b, Object.keys);
    },
    Jya: function (a) {
      return g.a.T5(a) ? a : Object(a);
    },
    Bma: function (a, b, c) {
      c || (c = {});
    ...
    Dpa: "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=",
    eg: Date.now
      ? function () {
          return Date.now();
        }
    ...
    ND: function (a, b, c, d) {
      ...
      if (d) {
        ...
        e = function () {
          l
            ? (m = arguments)
            : ((l = !0), a.apply(c, arguments), setTimeout(n, b));
        };
      }
      return e;
    },
    ...
    D9: function (a) {
      ...
      for (var c, d = 0, e = a.length; d < e; d += 1)
        (c = a.charCodeAt(d)), (b = (b << 5) - b + c), (b &= b);
      return b;
    },
    DDa: function (a, b) {
    ...
    iepngFix: function (a) {
      ...
      window.DD_belatedPNG && this.HS
        ? setTimeout(function () {
            b();
          }, 100)
        : this.HS || g.ub.load("AMap.FixPng", b);
    },
    Ka: function (a) {
      if (g.a.isArray(a))
        if (g.a.isArray(a[0]))
          for (var b = 0; b < a.length; b += 1) a[b] = g.a.Ka(a[b]);
        else if (((b = typeof a[0]), "string" === b || "number" === b))
    ...
    Mq: function (a) {
      return g.a.isArray(a) ? new g.zd(a[0], a[1]) : a;
    },
    GP: function (a) {
      var b = a.type,
        c = a.YU,
  ...
  g.a.uU = window.requestIdleCallback
    ? function (a, b) {
  ...
  g.a.cQ = window.cancelIdleCallback
    ? function (a) {
  ...
  (function (a) {
    var b = 1,
      c = {};
    a.a.Kxa = function (a, b) {
      if (c[a]) {
        var f = c[a];
        f.IE = 1;
        f.result = b;
        if (f.pn) {
          for (var h = f.pn, k = 0, l = h.length; k < l; k++)
            h[k].call(null, b);
          f.pn = null;
        }
      }
  ...
  (function (a) {
    var b = a.da.extend({
      ...
      tga: function () {
        a.Mj && a.Mj.h("vecTileParsed.buildings", this.$fa, this);
      },
      M5: function (a) {
        return a.map.KZ;
      },
      Yqa: function (a) {
        return this.M5(a) ? a.map.SN : null;
      },
      Hxa: function (a, b) {
        if (b) {
          var e = b.map;
          e &&
            (e.SN ? e.SN.toString() : "") !== (a ? a.toString() : "") &&
            ((e.SN = a || []), e.set("display", 0));
        }
      },
      c9: function (a, b) {
        if (b) {
          var e = b.map;
          e && e.KZ !== a && ((e.KZ = a), e.set("display", 0));
        }
      },
      WBa: function () {},
      GZ: function (a, b) {
      ...
      G3: function (b) {
        ...
        for (var d = 0, e = b.length; d < e; d++)
          if (
            a.q.fi &&
            b[d] instanceof a.q.fi &&
            b[d].ha &&
            b[d].ha.length &&
            (-1 !== b[d].ha.indexOf("building") ||
              -1 !== b[d].ha.indexOf("poilabel")) &&
            b[d].Ra
          ) {
      ...
      vqa: function (a) {
        if ((a = this.G3(a))) {
          ...
          for (var b = [], e = 0, f = a.length; e < f; e++) {
            var h = a[e];
            h.qe && h.qe.uf && this.GZ(h.qe.uf, b);
          }
          return b;
        }
      },
      $fa: function (a) {
        if (a.tp && a.tp.qe) {
          ...
          if (b) {
            var e = [];
            this.GZ(b, e);
            this.r("vecTileParsed.builds.found", { r2: e, tp: a.tp });
          }
        }
      },
    });
  ...
  (function (a) {
    ...
    function d(a) {
      function b(c, d) {
        ...
        p
          ? p[l]
            ? m
              ? p[l].apply(p, n.concat(e))
              : e(null, p[l].apply(p, n))
            : e("Unknown cmd: " + l)
      ...
      for (d in this._wkHandlers)
        -1 !== d.indexOf("_def_") && (e = this._wkHandlers.eGa = d);
      "function" === typeof this._wkHandlers[e].A &&
        this._wkHandlers[e].A.call(this._wkHandlers[e]);
      a.Au = function (a) {
        c.push.apply(c, a);
      };
      a.addEventListener(
        ...
        function (d) {
          function e(b) {
            if (t) {
              ...
              console.error("Seemed callback already sent!!", b, b.result.mc);
          }
          var f = d.data;
          d = f.axa || [f];
          for (
            var h = d.length, n = 0, p = Date.now() - f.bA, t = [], f = 0;
            f < h;
            f++
          )
            b(d[f], e);
    ...
    function e(d, h) {
      ...
      this.RB(null);
      this.w.lazy || this.oy();
      a.Ora || !1 === this.w.hostWorker || (a.Ora = this);
    ...
    a.extend(e.prototype, {
      ...
      qka: function () {
        ...
        this.E0 = a;
        if (this.Tx) {
          for (var b = 0, c = this.Tx.length; b < c; b++)
            this.Tx[b].apply(null, a);
          this.Tx.length = 0;
        }
      },
      Au: function (a) {
        this.hka && this.Sp.push.apply(this.Sp, a);
      },
      pT: function (a) {
        this.E0
          ? a.apply(null, this.E0)
          : (this.Tx || (this.Tx = []), this.Tx.push(a));
      },
      oy: function (b) {
        var c = this;
        if (!c.LX) {
          ...
          a.l.JS
            ? this.dka(function (a, b) {
                b
                  ? this.Aga(b, function (a, c) {
                      a
                        ? d(a)
                        : (this.RB(c),
                          (this.CP = c),
      ...
      xf: function (b, c) {
        ...
        f.pT(function (a) {
          a
            ? d(a)
            : f.CP
            ? ((a = f.VY(c, f.EN(f.YA, b), !0)),
              f.CP.sendMessage(e.VR + ":injectCode", a, function (a, b) {
                a || f.RB(f.CP, h);
                d(a, b);
              }))
      ...
      bda: function (a) {
        var b = {},
          c;
        for (c in a) a.hasOwnProperty(c) && this.qX(c, a[c], b);
        return b;
      },
      qX: function (a, b, c) {
        b = b.call(null, !1);
        for (var d in b)
          b.hasOwnProperty(d) &&
            ((c[a + ":" + d] = b[d]), a === this.oG && (c[d] = b[d]));
      },
      RB: function (a, b) {
        if (!b) this.mo || (this.mo = this.bda(this.EG)), (b = this.mo);
        else if (this.mo)
          for (var c in b) b.hasOwnProperty(c) && (this.mo[c] = b[c]);
        for (c in b)
          if (b.hasOwnProperty(c)) {
            var d = b[c];
            "function" === typeof d && (this[c] = this.Afa(c, d, a));
          }
        this.hka = !!a;
      },
      VY: function (a, b) {
      ...
      dka: function (a) {
        ...
        for (d in this.EG)
          if (this.EG.hasOwnProperty(d)) {
            var f = this.VY(this.EG[d], this.EN(b, d));
            f && c.push(f);
          }
        ...
        c && c !== r
          ? c.pT(function (b, c) {
              b
                ? a.call(r, b)
                : c.jAa.sendMessage(e.VR + ":injectCode", h, function (b) {
                    b ? a.call(r, b) : a.call(r, null, c.Fma);
                  });
            })
          : a.call(r, null, r.ula(h));
      },
      ula: function (b) {
      ...
      Eca: function (b, c) {
        ...
        if (!b.v0) {
          var d = this;
          b.v0 = setTimeout(function () {
            b.v0 = null;
            var c = b.yO;
            c.length &&
              (d.Rx(b, 1 === c.length ? c[0] : { bA: a.a.eg(), axa: c }),
              (c.length = 0));
          }, 0);
        }
      },
      ...
      Aga: function (a, b) {
        ...
        c.lla(a);
        var d = this.Vda(a);
        if (e.Ada) b.call(c, null, { sendMessage: d });
        else {
          e.Ada = !0;
          var f = [
            c.OY() + ":checkup",
    ...
    if (!g.WL) {
      ...
      b.send = function (b) {
        ...
        b.params &&
          b.params.rs &&
          !b.params.type &&
          ((b = a.DD[b.id].time), delete b.z5, (k = g.extend(k, b)));
        b = [];
        for (var m in k)
          l.isArray(k[m])
            ? b.push([m, k[m].join("-")].join("="))
            : b.push([m, k[m]].join("="));
        b.push("jl=" + (d.PJ ? 1 : 0));
        if (
          l.kk(window.performance, "performance") &&
          ...
          l.Ub(window.performance.getEntriesByType("resource"), function (a) {
            ...
            b &&
              ...
              l.ka(p, b) &&
              l.ka(q, c) &&
              (n += parseInt(a.responseEnd - a.startTime));
          });
          0 !== n && b.push("sd=" + n);
        }
            ...
            return {
              ...
              yh: function (a, b) {
                var e = a.Od,
                  f = a.Je,
                  h = "building" === a.ha[0];
                ((f && e !== this.tx.oE && this.tx.oE) ||
                  (!f && !h && e !== this.tx.pk && this.tx.pk)) &&
                  this.Sla(!!f);
              ...
              Sla: function (a) {
                if (a) this.lX();
                else if (!a && Object.keys(this.Tk).length)
                  for (var b in this.Tk)
                    this.Tk.hasOwnProperty(b) &&
                      ((a = this.Tk[b]), a.Ot || a.abort());
              },
              Sya: function () {
                this.Tt > this.i_ &&
                  this.fU(
                    Object.keys(this.Wj).slice(0, Math.floor(this.i_ / 2))
                  );
              },
              fU: function (a) {
                ...
                function e(e, f) {
                  var m =
                    2 < arguments.length && void 0 !== arguments[2]
                      ? arguments[2]
                      : !1;
                  if (p.Tk[q.AE] || p.pga(q)) {
                    var n = e.split("|");
                    f && (n[0] = f + n[0]);
                    var t = n,
                      x = "";
                    n[n.length - 1] &&
                      ((x = n[n.length - 1]), (t = n.splice(0, n.length - 1)));
                    if (k)
                      ...
                      p.Ws(p.extend({}, a, { fF: t, Od: h, Dn: m, BS: !0 }), b);
                    return x;
                  }
                  r || (p.Ml(l, b), (r = !0));
                }
              ...
              bE: function (a) {
                function b(d, p, r) {
                  ...
                  if (d && "loaded" !== d.status && -1 !== m.indexOf(t))
                    if ("limg" === t)
                      (p = h[1]),
                        (d.td = p),
                        "string" === typeof p.b && (p.b = w.cB(p.b)),
                        (r = ""),
                        (r = "object" === typeof p.u ? p.u.url : p.u) &&
                          (p.u = { url: r, Dk: "limg-" + d.key + "-" + f });
                    else {
                      p = {
                        Ig: d.ta,
                        Pi: s,
                ...
                var e = a.Jb,
                  ...
                  r = Math.pow(2, v);
                10 > v &&
                  (s <= p && b(s + r, u, v), s >= r - p && b(s - r, u, v));
                b(s, u, v);
              },
              J0: function (a) {
                for (var b = this.ro.length - 1; 0 <= b; b--)
                  this.ro[b] === a && this.ro.splice(b, 1);
              },
              pga: function (a) {
              ...
              Ml: function (a, b) {
                b(null, { Jb: a, U5: !0, disabled: this.disabled }, { el: !0 });
              },
            };
          },
          { batchSend: !1 }
  ...
  g.f = {
    ...
    JD: function (a, b, c) {
      return a.parentNode == b
        ...
        : a.parentNode &&
          ...
          !g.f.An(a.parentNode, c)
        ? g.f.JD(a.parentNode, b)
        : !1;
    },
    No: function (a) {
      if (!a) return [0, 0];
      ...
      (b && c) ||
        !a.childNodes[0] ||
        ((b = b || a.childNodes[0].offsetWidth),
        (c = c || a.childNodes[0].offsetHeight));
      window.opera &&
        ((b = Math.max(b, a.childNodes[0].scrollWidth)),
    ...
    nJ: function (a) {
      if (a)
        return new g.zd(
          a.clientWidth || document.body.clientWidth,
          a.clientHeight ||
            (g.l.Gs
    ...
    UR: function (a) {
      ...
      do {
        ...
        g.f.dpa() ||
          ...
          k &&
            "hidden" !== g.f.$c(d, "overflow-y") &&
            "hidden" !== g.f.$c(d, "overflow") &&
            (c += 17));
        d = d.parentNode;
      } while (d);
      return new g.H(c, b);
    ...
    dpa: function () {
      g.f.oea ||
        ((g.f.oea = !0),
        (g.f.nea = "ltr" === g.f.$c(document.body, "direction")));
      return g.f.nea;
    },
    ...
    g3: function () {
      document.selection &&
        ...
        document.selection.empty();
      this.kja ||
        ((this.kja = document.onselectstart),
        (document.onselectstart = g.a.C3));
    },
    t3: function () {},
    Lya: function (a, b, c) {
    ...
    An: function (a, b) {
      if (a && b)
        return (
          0 < a.className.length &&
          RegExp("(^|\\s)" + b + "(\\s|$)").test(a.className)
        );
    },
    Wa: function (a, b) {
      a &&
        ...
        (a.classList && a.classList.add
          ? a.classList.add(b)
          : g.f.An(a, b) || (a.className += (a.className ? " " : "") + b));
    },
    Axa: function (a, b) {
      a && (a.className = b || "");
    },
    ...
    OEa: function (a, b) {
      return g.f.L4(b.add(b.Pd(-1 * a))) + (" scale(" + a + ") ");
    },
    g9: function (a, b, c) {
      a.bj = b;
      !c && g.l.TH
        ? ((b = g.f.L4(b)),
          (c = a.style[g.f.qg].split("rotate")),
          1 < c.length
            ? ((c[0] = b), (a.style[g.f.qg] = c.join("rotate")))
            : (a.style[g.f.qg] = b),
          g.l.M6 && (a.style.WebkitBackfaceVisibility = "hidden"))
        : ((a.style.left = b.x + "px"), (a.style.top = b.y + "px"));
    },
    Wd: function (a) {
      a.bj ||
        (a.bj = a.style.left
          ? new g.H(parseInt(a.style.left), parseInt(a.style.top))
          : new g.H(0, 0));
      return a.bj;
    },
    CHa: function (a, b) {
    ...
    Z8: function (a, b) {
      ";" !== b[b.length - 1] && (b += ";");
      return b.toLowerCase() !== a.style.cssText.replace(/ /g, "").toLowerCase()
        ? ((a.style.cssText = b), !0)
        : !1;
    },
    ab: function (a, b) {
    ...
    rotate: function (a, b, c) {
      ...
      d
        ? ((a.style[d] = "" + (" rotate(" + b + "deg)")),
          (a.style[g.f.qt[d] + "-origin"] = c.x + "px " + c.y + "px"))
        : ((d = Math.cos((b * Math.PI) / 180)),
    ...
    getElementsByClassName: function (a, b, c) {
      ...
      for (var d = 0, e; d < b.length; d++)
        (e = b[d]), a.test(e.className) && c.push(e);
      return c;
    },
    fillText: function (a, b) {
      if (a)
        return (
          void 0 !== a.textContent
            ? (a.textContent = b)
            : void 0 !== a.innerText
            ? (a.innerText = b)
            : (a.innerHTML = b),
  ...
  (function () {
    ...
    g.extend(g.f, {
      ...
      t3: function () {
        ...
        a &&
          "none" !== b &&
          ((document.documentElement.style[a] = b), (b = "none"));
      },
      Woa: function () {
  ...
  g.f.iBa =
    "webkitTransition" === g.f.LF || "OTransition" === g.f.LF
      ? g.f.LF + "End"
      : "transitionend";
  g.F = {
    h: function (a, b, c, d) {
      ...
      if (g.l.V7 && 0 === b.indexOf("touch"))
        return (a[h] = e), this.$la(a, b, e, f);
      g.l.Uf && "dblclick" === b && this.Yla && this.Yla(a, e, f);
    ...
    G: function (a, b, c, d) {
      ...
      g.l.eR && "mousewheel" === b && (b = "DOMMouseScroll");
      !g.l.Gs ||
        ("mouseover" !== b && "mouseout" !== b) ||
        (b = "mouseover" === b ? "mouseenter" : "mouseleave");
      g.l.V7 && -1 < b.indexOf("touch")
        ? this.Hwa(a, b, c)
        : g.l.Uf && "dblclick" === b && this.Dwa
        ? this.Dwa(a, c)
        : "removeEventListener" in a
        ? a.removeEventListener(b, e, !1)
        : "detachEvent" in a && -1 === b.indexOf("touch")
    ...
    zxa: function (a) {
      return a && a.getBoundingClientRect
        ? ((a.uM = a.getBoundingClientRect()),
          (a.XW = [a.clientLeft, a.clientTop]),
          !0)
        : !1;
    },
    Aza: function (a) {
      a.uM && ((a.uM = null), (a.XW = null));
    },
    Upa: function (a, b) {
      var c = b.uM || b.getBoundingClientRect(),
        d = b.XW || [b.clientLeft, b.clientTop];
      return new g.H(a.clientX - c.left - d[0], a.clientY - c.top - d[1]);
    },
    mm: function (a, b) {
      if (b && b.getBoundingClientRect) return this.Upa(a, b);
      var c = document.body,
        d = document.documentElement,
        c = new g.H(
          g.l.Uf ? a.pageX : a.clientX + (c.scrollLeft || d.scrollLeft),
          g.l.Uf ? a.pageY : a.clientY + (c.scrollTop || d.scrollTop)
        );
    ...
    Hwa: function (a, b, c) {
      ...
      switch (b) {
        ...
        case "touchmove":
          ...
          break;
        case "touchend":
          a.removeEventListener(this.Po("pointerup"), c, !1),
            a.removeEventListener(this.Po("pointercancel"), c, !1);
      }
      return this;
    },
  });
      ...
      YGa: function (b, d) {
        ...
        b.Cp.length ||
          (c
            ...
            : (b.Dp.contentDocument.defaultView.removeEventListener(
                "resize",
                a
              ),
              (b.Dp = !b.removeChild(b.Dp))));
      },
      Jna: function (a) {
        a.Cp = null;
        if (a.Dp) {
  ...
  g.ub = {
        ...
        try {
          if (g.l.Kv && window.localStorage) {
            ...
            d &&
              ((d = JSON.parse(d)),
              d.version === g.o.Fk
                ? (window._jsload_(a, d.script, !0),
                  d.css && window._cssload_(a, d.css, !0))
    ...
    SC: function (a) {
      this.Ou[a] ||
        ((this.Ou[a] = {}), (this.Ou[a].status = 0), (this.Ou[a].py = []));
      return this.Ou[a];
    },
    remove: function (a) {
      this.Ou[a] = null;
  ...
  window._jsload_ = function (a, b, c) {
    var d = g.ub.SC(a);
    d.WK &&
      0 <= g.a.indexOf(document.body.childNodes, d.WK) &&
      document.body.removeChild(d.WK);
    d.WK = null;
    try {
      if (!c && window.localStorage && b && "" !== b && g.l.Kv) {
        var e = window.localStorage["_AMap_" + a],
          e = e || "{}",
          e = JSON.parse(e);
        e.version !== g.o.Fk || e.script
          ? window.localStorage.setItem(
              "_AMap_" + a,
              JSON.stringify({ version: g.o.Fk, script: b })
            )
          : window.localStorage.setItem(
              "_AMap_" + a,
              JSON.stringify({ version: g.o.Fk, script: b, css: e.css })
            );
      }
    } catch (f) {}
    g.ub.On(a, b);
  ...
  window._cssload_ = function (a, b, c) {
    try {
      !c &&
        ...
        window.localStorage.setItem(
          "_AMap_" + a,
          JSON.stringify({ css: b, version: g.o.Fk })
        );
    } catch (d) {}
    var e = document.createElement("style");
    e.type = "text/css";
    -1 === g.o.Hb.indexOf("webapi.amap.com") &&
      (b = b.replace(/webapi.amap.com/gi, g.o.Hb.split("://")[1]));
    ...
    2 > a.childNodes.length
      ? a.appendChild(e)
      : a.insertBefore(e, a.childNodes[1]);
  };
  (function (a) {
    var b = g.l;
    if (!g.indexedDB && b.Oi) {
      var c =
          a.indexedDB || a.webkitIndexedDB || a.msIndexedDB || a.mozIndexedDB,
      ...
      if (c) {
        ...
        g.indexedDB = {
          mC: function (a, b) {
            f
              ...
              : h.h("dbReady", function (c) {
                  "success" === c.status
                    ? "function" === typeof a && a()
                    : "function" === typeof b && b({ code: 3, status: status });
                });
          },
          count: b(function (a) {
            var b = this,
          ...
          xka: b(function (a, b) {
            ...
            e.isArray(a) || (a = [a]);
            a = a.sort();
            c.openCursor(d.bound(a[0], a[a.length - 1])).onsuccess = function (
              c
            ) {
  ...
  (function () {
    ...
    function h() {
      ...
      a &&
        (a.vdataVer === u.data.vdataVer && a.apiVer === u.data.apiVer
          ? (u.data = a)
          : e());
    }
    function k() {
    ...
    if (!g.Oj && q.Oi) {
      var s = g.indexedDB,
        u = { YL: 1e3, key: "_AMap_data.tileKeys" },
        v = [],
        w = {
          ...
          setItem: function (a, b, c) {
            ...
            c &&
              ((d = JSON.stringify(b)),
              1.5 < d.length / 1024 / 1024 &&
                Object.keys(b.nqa).length &&
                ((b.nqa = {}), (d = JSON.stringify(b))));
            try {
      ...
      g.Oj = {
        ...
        get: function (c, d) {
          function f(a) {
            var b = { lS: l, L6: G, ZFa: w, Ug: u.data.config };
            a &&
              B.length &&
              (/\|limg/.test(B[0])
                ? (b.r6 = a
          ...
          var k = "FS" === c.type;
          if (!q.Kv || !(k || (q.Oi && 0 !== u.data.keys.length)))
            return d({ code: 1 });
          var l = [],
            w = [],
            B = [],
          ...
          c.Dya.forEach(function (a) {
            ...
            k &&
              ...
              u.data.fsTiles[e] &&
                (l.push(a),
                B.push(e),
                H.push({ data: p(u.data.fsTiles[e]), tileKey: e }),
                (d = !0)));
            d ||
              (q.Oi && r.ka(u.data.keys, e)
                ? (B.push(e), w.push(a))
                : G.push(a));
          });
          ...
          s.get(B, { timeout: c.timeout || 1e3 }, function (b, c) {
            if (b || c.length !== B.length)
              b && 3 === b.code ? (q.Oi = !1) : e(), (G = w), (w = []), f(null);
            else {
              if (k)
                for (var d = c.length - 1; 0 <= d; d--) {
                  var h = c[d];
                  h && h.data
                    ? (u.data.fsTiles[h.tileKey] = n(h.data))
                    : G.push(w.splice(d, 1)[0]);
                }
              l = w;
              w = [];
              f(c);
          ...
          return function () {
            ...
            if (a) {
              if (Object.keys(u.data.fsTiles).length)
                for (var c in u.data.fsTiles)
                  u.data.fsTiles.hasOwnProperty(c) &&
                    !r.ka(v, c) &&
                    delete u.data.fsTiles[c];
              q.Oi
          ...
          f.length
            ? (f.forEach(function (a) {
                ...
                a
                  ...
                  ? (r.ka(u.data.keys, a) ||
                      (h.push(a), d.push({ tileKey: a, data: c })),
                    r.ka(v, a) &&
                      void 0 === u.data.fsTiles[a] &&
                      (u.data.fsTiles[a] = c))
                  : (b[a] = c);
              }),
              d.length &&
                  ...
                  ? s.add(d, function (a) {
                      a
                        ? 3 !== a.code
                          ? e()
                          : (q.Oi = !1)
                        : ((u.data.keys = u.data.keys.concat(h)),
                          w.setItem(u.key, u.data, !0),
                          c());
                    })
                  : w.setItem(u.key, u.data, !0)),
  ...
  g.U = g.da.extend({
    ...
    offset: function (a, b) {
      ...
      var c =
          2 *
          Math.asin(
            Math.sin(Math.round(a) / 12756274) /
              Math.cos((this.Q * Math.PI) / 180)
          ),
    ...
    hb: function (a) {
      a = g.a.Ka(a);
      return a instanceof g.U
        ? 1e-9 >= Math.max(Math.abs(this.Q - a.Q), Math.abs(this.R - a.R))
        : !1;
    },
    toString: function () {
  ...
  g.U.Uqa = function (a, b, c) {
    ...
    for (
      var k =
          2 * k(l(n(m((r - s) / 2), 2) + p(r) * p(s) * n(m((a - b) / 2), 2))),
        u,
        v,
        w,
        t,
      ...
      (u = (1 / c) * f),
        (v = m((1 - u) * k) / m(k)),
        (w = m(u * k) / m(k)),
        (u = v * p(r) * p(a) + w * p(s) * p(b)),
        (t = v * p(r) * m(a) + w * p(s) * m(b)),
        (v = v * m(r) + w * m(s)),
        (v = q(v, l(n(u, 2) + n(t, 2)))),
        (u = q(t, u)),
        b > a
  ...
  g.pe = g.da.extend({
    ...
    yi: function () {
      return new g.U(
        this.wc.R > this.oc.R
          ? ((this.wc.R + this.oc.R + 360) / 2) % 360
          : (this.wc.R + this.oc.R) / 2,
        (this.wc.Q + this.oc.Q) / 2
      );
    },
    extend: function (a) {
  ...
  g.H = g.da.extend({
    ...
    Nu: function (a) {
      var b = this.length(),
        c = a.length();
      return b && c
        ? (180 * Math.acos((this.x * a.x + this.y * a.y) / c / b)) / Math.PI
        : null;
    },
    Boa: function (a) {
      var b = this.length(),
  ...
  g.zd = g.da.extend({
    ...
    contains: function (a) {
      return (
        Math.abs(a.x) <= Math.abs(this.width) &&
        Math.abs(a.y) <= Math.abs(this.height)
      );
    },
    hb: function (a) {
      return (
        a instanceof g.zd && this.width === a.width && this.height === a.height
      );
    },
    toString: function () {
  ...
  g.vp = g.da.extend({
    ...
    contains: function (a, b) {
      ...
      a instanceof g.H
        ? (a = [a.x, a.y])
        : a instanceof g.U && (a = [a.R, a.Q]);
      return g.yd.Ud(a, this.path, b);
    },
    toBounds: function () {
      for (
        var a = new g.pe(180, 90, -180, -90), b = this.Td.length - 1;
        0 <= b;
        b -= 1
      )
        a.extend(this.Td[b]);
  ...
  g.Xf = g.da.extend({
    A: function () {
      if (2 === arguments.length)
        (this.kc = arguments[0]), (this.Xd = arguments[1]);
      else if (
    ...
    yi: function (a) {
      return new g.H(
        (this.kc.x + this.Xd.x) / 2,
        (this.kc.y + this.Xd.y) / 2,
        a
      );
    },
    contains: function (a) {
      ...
      return (
        b.x > this.kc.x && a.x < this.Xd.x && b.y > this.kc.y && a.y < this.Xd.y
      );
    },
    wj: function () {
  ...
  g.I.TP = function (a) {
    for (
      var b = [Infinity, Infinity, -Infinity, -Infinity], c = 0, d = a.length;
      c < d;
      c += 1
    )
      g.I.KI(b, a[c]);
  ...
  g.I.xoa = function (a, b, c, d, e) {
    return "undefined" !== typeof e
      ? ((e[0] = a), (e[2] = b), (e[1] = c), (e[3] = d), e)
      : [a, c, b, d];
  };
  ...
  g.I.transform = function (a, b, c) {
    ...
    b(a, a, 2);
    return g.I.f2([a[0], a[2], a[4], a[6]], [a[1], a[3], a[5], a[7]], c);
  };
  g.pe.Ib({
    A: (function () {
  ...
  g.MF = g.da.extend({
    ...
    transform: function (a, b) {
      return this.x1(a.eb(), b);
    },
    x1: function (a, b) {
      b = b || 1;
      a.x = b * (this.jX * a.x + this.zX);
      a.y = b * (this.NX * a.y + this.jY);
      return a;
    },
    Bza: function (a, b) {
      b = b || 1;
      return new g.H(
        (a.x / b - this.zX) / this.jX,
        (a.y / b - this.jY) / this.NX
      );
    },
  });
  g.Bp = g.da.extend({
    A: function (a) {
      ...
      a.project &&
        a.unproject &&
        ((this.lc = a.project), (this.Xh = a.unproject));
    },
  });
  g.Bp.uW = {
    lc: function (a) {
  ...
  g.Bp.vba = new g.Bp({
    ...
    unproject: function (a, b) {
      ...
      return new g.U(
        a.x * c,
        (2 * Math.atan(Math.exp(a.y)) - Math.PI / 2) * c,
        b
      );
    },
  });
    ...
    Xh: function (a, b) {
      for (
        var c = 180 / Math.PI,
          ...
          d = Math.sqrt(1 - d * d),
          e = Math.exp(-a.y / e),
          h = Math.PI / 2 - 2 * Math.atan(e),
          k = 15,
          l = 0.1;
        1e-7 < Math.abs(l) && ((k -= 1), 0 < k);

      )
        (l = d * Math.sin(h)),
          (l =
            Math.PI / 2 -
            2 * Math.atan(e * Math.pow((1 - l) / (1 + l), 0.5 * d)) -
            h),
          (h += l);
  ...
  g.$h.fW = g.extend({}, g.$h.rF, {
    code: "EPSG:4326",
    Qf: g.Bp.uW,
    WE: new g.MF(1 / 360, 0.5, -1 / 360, 0.25),
  });
  g.$h.eBa = g.extend({}, g.$h.rF, { Qf: g.Bp.uW, WE: new g.MF(1, 0, 1, 0) });
  g.UJ = {
    lc: function (a, b) {
      a = g.a.Ka(a);
    ...
    Ns: function (a, b) {
      ...
      b &&
        (c =
          "string" === typeof b
            ? Math.round(parseFloat(b) / 0.14929107086948487)
            : b);
      var d = this.Cb(a);
    ...
    NBa: function (a) {
      return new g.H(a.x + 2.0037508342789244e7, 2.0037508342789244e7 - a.y).nd(
        0.14929107086948487
      );
    },
    z7: function (a) {
      return new g.H(
        0.14929107086948487 * a.x - 2.0037508342789244e7,
        2.0037508342789244e7 - 0.14929107086948487 * a.y
      );
    },
  };
  z.PF = g.da.extend({
  ...
  z.Sb = g.da.extend({
    ...
    w: {
      ...
      copyright:
        "\x3c!--v1.4.16--\x3e &copy " + new Date().getFullYear() + " AutoNavi ",
      isHotspot: !g.l.ba,
      baseRender: g.l.Y1,
      overlayRender: g.l.sva,
        ...
        g.ub.Gg(b, function () {
          d.w6(function () {
            d.map &&
              ...
              d.map.GG && d.map.GG(),
              d.map.Se &&
                d.map.Se instanceof g.Sb.EF &&
                d.map.Se.je &&
                d.map.Se.je.S &&
                (d.map.Se.je.S.fI(),
                (d.map.Se.je.S.Q6 = c),
                d.map.Se.je.S.reload()),
              d.set("display"));
          });
        });
      }
    ...
    setMapStyle: function (a) {
      ...
      -1 === a.indexOf("amap://styles/")
        ? g.o.gK[a]
          ? this.set("styleUrl", "amap://styles/" + g.o.gK[a])
          : this.set("styleUrl", "")
        : this.set("styleUrl", a);
      this.bT();
    },
    ...
    setLang: function (a) {
      ...
      ("en" !== a && "zh_cn" !== a && "zh_en" !== a) ||
        a === this.get("lang", null, !0) ||
        (this.set("lang", a), this.ik && this.ik.F8(this));
    },
    getLang: function () {
    ...
    setCity: function (a, b) {
      ...
      var c = this,
        d =
          g.o.fd +
          "/v3/config/district?subdistrict=0&extensions=all&key=" +
          g.o.key +
          "&s=rsv3&output=json&keywords=" +
          a;
    ...
    getScreenShot: function (a, b) {
      ...
      return this.map && g.l.kl ? this.map.J4(a, b) : "";
    },
    getCity: function (a, b) {
      g.c.add(this, "getCity");
      var c =
        g.o.fd +
        "/v3/geocode/regeo?&extensions=&&key=" +
        g.o.key +
        "&s=rsv3&output=json&location=" +
        (b || this.get("center", null, !0));
      g.o.Xa && (c += "&jscode=" + g.o.Xa);
      new g.kb.Ab(c, { callback: "callback", jy: !0, Gd: "REGEO" }).h(
        "complete",
        function (b) {
    ...
    A: function (a, b) {
      ...
      b.mapStyle &&
        g.o.gK[b.mapStyle] &&
        (b.mapStyle = "amap://styles/" + g.o.gK[b.mapStyle]);
      ...
      "3D" === b.viewMode &&
        g.l.sp &&
        void 0 === b.showBuildingBlock &&
        !0 === b.showBuildingBlock;
      ...
      var c = this.w.zooms[1],
        d = this.w.zooms[0];
      b.zooms
        ? ((b.zooms[0] = Math.max(d, b.zooms[0])),
          !0 === b.expandZoomRange && (c = g.l.ba ? (g.l.Kc ? 19 : 20) : 20),
          (b.zooms[1] = Math.min(c, b.zooms[1])))
        : (b.zooms = [d, c]);
      b.forceZooms && (b.zooms = b.forceZooms);
      b = this.pna(b);
      c = this.getSize(!0);
      b.center && (b.center = g.a.Ka(b.center));
      this.nj = this.yoa(b.crs || this.w.crs, b.center || this.w.center);
      this.uma(c, b);
      d = b.lang;
      ...
      g.l.JS
        ? !1 !== b.workerMode &&
          (z.Sb.Rt ? ((b.workerMode = !1), z.Sb.Rt++) : (z.Sb.Rt = 1))
        : (b.workerMode = !1);
      b.layers && ((d = b.layers), delete b.layers, (b.layers = d));
      b.baseRender = b.baseRender || g.l.Y1;
      ...
      g.l.kl &&
        (b.vectorMapForeign || b.mapStyle || b.nolimg) &&
        f.push("labelcanvas");
      b.editEnable && f.push("edit");
      g.l.kl &&
        (f.push("AMap.IndoorMap"),
        ...
        e.w6(function () {
          g.ub.Gg(f, function () {
            if (!e.get("destroy")) {
              var b = new g.Sb(a, e);
              if (g.Ue) {
                var c = (g.Ue[0] || g.Ue).stylemaps[
                  "50001:1"
                ].browserStyle[0].split("&");
                b.XF = [c[0], c[4]];
              }
              b.bf(
                "zoom center centerCoords rotation yaw pitch resolution".split(
                  " "
                ),
                e.view,
                !0
              ...
              "3D" === e.view.type &&
                (e.AmbientLight ||
                  (e.AmbientLight = new g.Vw.TV([1, 1, 1], 0.9)),
                e.DirectionLight ||
                  (e.DirectionLight = new g.Vw.dW([0, -1, 1], [1, 1, 1], 0.1)));
              e.C = !1;
            }
          });
        });
      });
      g.o.b6 && "1" === g.o.b6 && new z.q.mb.Qba({ innerLayer: !0, map: this });
    },
    f7: function (a) {
      if (a) {
      ...
      try {
        ...
        if (b)
          if (
            ((g.SJ = 0),
            (g.RJ = 0),
            "string" == typeof b && "style_" == b.substr(0, 6))
          ) {
            var c = this,
              d,
              e = b.slice(6);
            32 == e.length
              ? ((c.ls = !0),
                ...
                (d =
                  ...
                  "&key=" +
                  g.o.key +
                  "&sdkType=abroad_js_json&s=rsv3"),
                (d += "&platform=JS&logversion=2.0"),
                (d += "&appname=" + g.o.Ao),
                (d += "&csid=" + g.a.kr()),
                (d += "&sdkversion=" + g.o.Xl),
                g.o.Xa && (d += "&jscode=" + g.o.Xa))
              : ((c.ls = !1),
                (g.o.hqa = g.o.UI + b + "/"),
                (d = g.o.Hb + "/styles/foreign/web_v8_" + b + ".json"));
              ...
              function (b) {
                if (b && b.data && !b.data.TDa) {
                  ...
                  (d = b.style) &&
                    ...
                    ((g.Wta = d.layers),
                    b.zoomlevel &&
                      ((g.SJ = b.zoomlevel[0]), (g.RJ = b.zoomlevel[1])));
        ...
        (this.ls = !1), this.set("vectorMapForeign", !1), a();
      }
    },
    Nta: function (a) {
      function b() {
        ...
        if (a) {
          for (
            ...
            void 0 === b[e[a]] && ((b[e[a]] = d++), c.push(e[a]));
          c.reverse();
          d = 0;
      ...
      if (g.l.Ve || g.Ue) a();
        ...
        if (window.__AMapStyleSource) c = !1;
          ...
          try {
            ...
            d && d.version === g.l.mf && d.script && 100 < d.script.length
              ? eval(d.script)
              : (c = !1);
          } catch (e) {
            c = !1;
        ...
        if (c) b(), a();
          ...
          f.id = "amap_anole_js";
          f.src =
            window.__AMapStyleSource ||
            g.o.Cc +
              "://vdata.amap.com/style?v=" +
              g.o.Xl +
              "&key=" +
              g.o.key +
              "&mapstyle=normal";
          c = document;
          (c.head || c.getElementsByTagName("head")[0] || c.body).appendChild(
            f
          );
          f.onload = function () {
            if (!g.Ue) {
              if (AMap.anole && !window.__AMapStyleSource && g.l.Kv)
                try {
                  var c = {
                    version: g.l.mf,
    ...
    uma: function (a, b) {
      if (!(b && b.center && b.zoom)) {
        var c = this.xqa(g.o.Td, a, b.zooms);
    ...
    Txa: function (a, b) {
      ...
      e &&
        ((this.ex = new g.Lj(d, a, null, 0)),
        (this.ex.transition = function (a, c, e) {
          e /= b || 300;
          if (1 <= e) return c;
          var f = {},
            h;
        ...
        (this.ex.Kq = function (b) {
          ...
          for (var c in b)
            b.hasOwnProperty(c) &&
              ("center" === c
                ? ((this.C = !0), this.setCenter(b[c], !0), (this.C = !1))
                : this.set(c, b[c]));
        }),
        this.ex.On(this));
    },
    Aoa: function (a) {
      "3D" === this.get("viewMode") && g.l.sp
        ? (this.set("baseRender", "vw"), (this.view = new g.tM(this, a)))
        : (this.view = new g.PF(this, a));
      this.t5();
    },
    t5: function () {
    ...
    OU: function () {
      if (this.sm) {
        ...
        if (
          !1 === this.get("showIndoorMap") ||
          ("normal" !== b && "amap://styles/normal" !== b)
        )
          a = !1;
        for (
          var b = this.getLayers(), c = (this.C = !1), d = 0, e = b.length;
          d < e;
          d += 1
        ) {
          if (
            b.hasOwnProperty(d) &&
            "AMap.IndoorMap" === b[d].CLASS_NAME &&
            b[d] !== this.sm
          ) {
            a = !1;
            break;
      ...
      if (this.view && "3D" !== this.view.type) {
        ...
        if (a && !("dv" < a)) {
          ...
          b &&
            ...
            (d ||
              "all" !== b ||
              ("normal" !== c && "amap://styles/normal" !== c))
              ? (this.set("baseRender", "v"), (this.yT = a))
              : this.yT && (this.set("baseRender", this.yT), (this.yT = null)));
          this.t5();
        }
      }
    },
    ...
    z$: function () {
      function a() {
        ...
        if (
          g.a.ka(["d", "dv"], b.get("baseRender")) ||
          !g.a.ka(["normal", "amap://styles/normal"], b.get("mapStyle")) ||
      ...
      if (!this.j8) {
        ...
        if (d && !c) this.uk(d), this.set("rasterLayer", void 0);
          ...
          if (this.w.layers) {
            ...
            g.a.Ub(this.w.layers, function (a) {
              a instanceof z.q.mb &&
                a.HG &&
                (null === e || a.get("zIndex") > e.get("zIndex")) &&
                (e = a);
            });
    ...
    pna: function (a) {
      ...
      a.layers && 0 !== a.layers.length
        ? this.set("defaultLayer", a.layers[0], !0)
        : ((b = new z.q.mb({ innerLayer: !0 })),
          (a.layers = [b]),
          (b.JP = !0),
          this.set("defaultLayer", b, !0));
      if ((b = a.view))
        b.w.rotation && (a.rotation = b.w.rotation),
          b.w.center && (a.center = b.w.center),
          b.w.zoom &&
            (a.zoom = Math.max(a.zooms[0], Math.min(a.zooms[1], b.w.zoom))),
          b.w.crs && (a.crs = b.w.crs);
    ...
    RH: function (a) {
      ...
      if (
        !(0 <= g.a.indexOf(b, a)) &&
        (b.push(a), this.set("layers", b), a.zB)
      ) {
        a = a.getLayers();
      ...
      0 <= g.a.indexOf(b, a) ||
        (a instanceof z.B.Un
          ? (this.get("overlays").push(a),
            this.vy instanceof z.B.Un &&
              ((this.vy.C = !0), this.vy.close(), (this.vy.C = !1)),
            (this.vy = a),
            this.set("contextmenu", a, !0))
          : (a instanceof z.B.Ze &&
              (this.tm instanceof z.B.Ze && this.Lz(this.tm), (this.tm = a)),
            this.get("overlays").push(a)),
        this.r("overlays"));
    },
    uk: function (a) {
      ...
      if (-1 !== c) {
        ...
        else a.$A && a.$A.$ka(a), (b = g.a.Ho(b, c));
        this.set("layers", b);
        if (a.zB)
          for (a = a.getLayers(), b = -1, c = a.length; ++b < c; )
            (d = a[b]), d instanceof z.q.Zb || !d.setMap || d.setMap();
      }
    },
    getZooms: function () {
    ...
    getZoom: function (a) {
      ...
      return a
        ? this.get("zoom", null, !0)
        : this.iD(this.get("targetLevel") || this.get("zoom", null, !0));
    },
    getCenter: function () {
    ...
    setCenter: function (a, b) {
      ...
      b || !this.loaded
        ? (this.r("movestart"),
          this.set("center", a),
          this.r("mapmove"),
          this.map ? this.map.r("moveend") : this.r("moveend"))
        : ((this.C = !0), this.panTo(a), (this.C = !1));
    },
    getCoordsBound: function () {
      return this.view.lm();
    },
    getCoordsBoundByZoom: function (a) {
      return this.view.uqa(a);
    },
    ...
    getStatus: function () {
      ...
      for (
        var a =
            "isHotspot pitchEnable dragEnable zoomEnable keyboardEnable jogEnable doubleClickZoom scrollWheel resizeEnable touchZoom rotateEnable animateEnable".split(
              " "
            ),
          b = {},
          c = 0;
    ...
    setStatus: function (a) {
      ...
      for (var b in a)
        a.hasOwnProperty(b) &&
          -1 !==
            "isHotspot,pitchEnable,dragEnable,keyboardEnable,doubleClickZoom,scrollWheel,zoomEnable,jogEnable,continuousZoomEnable,resizeEnable,animateEnable,rotateEnable,touchZoom".indexOf(
              b
            ) &&
          this.set(b, a[b]);
    },
    ...
    getDefaultCursor: function () {
      ...
      return (
        this.get("defaultCursor", null, !0) ||
        "url(" + g.o.Hb + "/theme/v1.3/openhand.cur),default"
      );
    },
    ...
    iD: function (a) {
      return this.view && "3D" === this.view.type
        ? g.a.xb(a, 4)
        : Math.round(a);
    },
    setZoomAndCenter: function (a, b, c) {
      ...
      this.C = !0;
      this.loaded
        ? this.set("zoomAndCenter", [a, b, c])
        : (this.setZoom(a, !0), this.setCenter(b, !0));
      this.C = !1;
    },
    clearMap: function () {
    ...
    clearControl: function () {
      ...
      a.Nd = a.Nd || {};
      for (var b in a.Nd)
        a.Nd.hasOwnProperty(b) && (a.remove.push(a.Nd[b]), delete a.Nd[b]);
      this.set("controls", a);
    },
    plugin: function (a, b) {
      g.c.add(this, "plugin");
      ...
      for (var c = [], d = 0; d < a.length; d += 1) {
        ...
        2 < e.length ||
          (2 == e.length
            ? "AMap" === e[0] && (window.AMap[e[1]] || c.push(a[d]))
            : c.push(a[d]));
      }
    ...
    clearInfoWindow: function () {
      ...
      a &&
        0 !== a.length &&
        this.tm &&
        ((this.tm.C = !0), this.tm.close(), (this.tm.C = !1));
    },
    remove: function (a) {
      g.c.add(this, "remove");
    ...
    getAllOverlays: function (a, b) {
      ...
      if (a) {
        for (
          var d = "amap." + a.toLowerCase(), e = [], f = 0;
          f < c.length;
          f += 1
        )
          d !== c[f].CLASS_NAME.toLowerCase() ||
            (!b && (c[f].Da || c[f].isOfficial)) ||
            e.push(c[f]);
        return e;
      }
      if (!b) {
        ...
        for (f = 0; f < c.length; f += 1)
          c[f].Da || c[f].isOfficial || e.push(c[f]);
        c = e;
      }
      d = this.get("layers");
      e = [];
      if (d)
        for (var f = 0, h = d.length; f < h; f += 1)
          d[f] instanceof z.q.PL && e.push(d[f]),
            d[f].lb && (e = e.concat(d[f].lb));
      return c.concat(e);
    },
    ...
    panTo: function (a) {
      ...
      this.loaded
        ? this.set("panTo", a)
        : ((this.C = !0), this.setCenter(a), (this.C = !1));
    },
    panBy: function (a, b, c) {
      ...
      b =
        this.loaded && this.map && this.map.Hd
          ? this.map.Hd.K9
          : this.get("centerCoords");
    ...
    setFitView: function (a, b, c, d) {
      ...
      if ((a = this.v4(a))) {
        if ((c = this.dJ(a, 0, new g.H(40, 40), c, d)))
          (b =
            b ||
            !this.getBounds().contains(a.yi()) ||
            (g.l.ba && 1 < Math.abs(c[0] + this.get("zoom", null, !0)))),
    ...
    v4: function (a) {
      ...
      if (a) {
        for (var b, c = 0; c < a.length; c += 1) {
          ...
          if (
            d.get("visible") &&
            !(d instanceof z.B.Ze || d instanceof z.B.Un)
          ) {
            d.C = !0;
            var e = d.getBounds();
            d.C = !1;
    ...
    dJ: function (a, b, c, d, e) {
      ...
      this.yC.kf(
        { size: k, zoom: 3, rotation: f, pitch: h, centerCoords: m },
        !0
      );
      var n = (h = 0);
      d
        ? ((n = d[0]),
          ...
          (h = (h - d) / 2),
          (n = (n - c) / 2))
        : c && ((k.width -= 2 * c.x), (k.height -= 2 * c.y));
      e = e || (g.l.ba ? 17 : 18);
      c = this.get("zooms");
      d = c[0];
      var p = Infinity,
      ...
      do {
        ...
        "3D" === l && this.yC.jr();
        for (
          var q = (p = Infinity), r = -Infinity, s = -Infinity, u = 0;
          u < a.length;
          u += 1
        )
    ...
    getLayers: function () {
      ...
      if (this.C) {
        ...
        for (b = a.length; -1 < --b; )
          (c = a[b]),
            c.$A && a.splice(b, 1),
            c.WV && "AMap.TileLayer.Watermark" === c.WV && a.splice(b, 1);
      return a;
    },
    ...
    drawPolygon: function (a) {
      ...
      this.set(
        "drawStyle",
        a || { strokeColor: "#006600", rb: 0.9, fillColor: "#FFAA00", me: 0.9 }
      );
    },
    drawCircle: function (a) {
      ...
      this.set(
        "drawStyle",
        a || { strokeColor: "#006600", rb: 0.9, fillColor: "#006600", me: 0.9 }
      );
    },
    tD: function () {
      return this.view.tD();
    ...
    getCameraState: function () {
      ...
      if (this.view && "3D" == this.view.type) return this.view.W3();
    },
    endDraw: function () {
      this.set("draw", null);
    },
    ...
    gJ: function (a) {
      ...
      if (this.C) {
        for (var c = [], d = -1, e = b.length; ++d < e; ) {
          var f = b[d];
          if (f.zB)
            for (var f = f.FEa(), h = -1, k = f.length; ++h < k; ) {
              var l = f[h];
    ...
    queryObjectIndexFromFboByContainerPos: function (a, b) {
      ...
      if (c) (this.$G = this.view.Me.eb()), (this.ZG = this.view.dc.eb());
        ...
        if (
          ((c = this.ZG.$u(this.view.dc)),
          (c = !(this.$G.$u(this.view.Me) && c)))
        )
          (this.$G = this.view.Me.eb()), (this.ZG = this.view.dc.eb());
      } else (this.$G = this.view.Me.eb()), (this.ZG = this.view.dc.eb());
      if (c) this.map.Qq(d);
      else {
        for (var f = 0; f < d.length; f += 1) {
          var h = d[f];
          if (h instanceof z.q.Pm && h.Vra()) {
            c = !0;
            break;
          }
        }
      ...
      return this.map.Ry().owa(a, e);
    },
    diffFilterLayers: function (a) {
      a = a || [];
      if (!this.lu || this.lu.length !== a.length)
        return (this.lu = a ? a.slice(0) : []), !0;
  ...
  z.Sb.Yb({
    ...
    rqa: "geodeticCoordToLngLat",
    dJ: "getFitZoomAndCenterByBounds",
    h4: "getFitZoomAndCenterByOverlays",
  ...
  z.Sb.Ib({
    isHotspotChanged: function () {
      if (
        "undefined" !== typeof this.wD &&
        (this.Pna(), this.get("isHotspot"))
      ) {
        var a = this.get("layers", null, !0);
        a && a.length && !this.wD && this.aK && this.eva();
      }
    },
    eva: function () {
      if (this.ik) this.h5();
    ...
    h5: function () {
      ...
      this.ik.setMap(this);
      this.ik.C = !1;
      a.h("mouseover", this.s7, this);
      a.h("click", this.q7, this);
      a.h("mouseout", this.r7, this);
    },
    Zra: function () {
      var a = this.ik;
      a.G("mouseover", this.s7, this);
      a.G("click", this.q7, this);
      a.G("mouseout", this.r7, this);
      this.ik.C = !0;
      this.ik.setMap(null);
      this.ik.C = !1;
      this.ik = null;
  ...
  z.event = {
    ...
    addListener: function (a, b, c, d) {
      g.a.Qh(a.addListener)
        ? a.addListener(b, c, d)
        : (a.we || (a.we = g.va.we), g.va.h.call(a, b, c, d));
      return new g.uF(1, a, b, c, d);
    },
    fy: function (a, b, c, d) {
      g.a.Qh(a.fy)
        ? a.fy(b, c, d)
        : (a.we || (a.we = g.va.we), g.va.h.call(a, b, c, d, !0));
      return new g.uF(1, a, b, c, d);
    },
    mI: function (a) {
    ...
    removeListener: function (a) {
      a instanceof g.uF &&
        (g.a.Qh(a.Bi.removeListener)
          ? a.Bi.removeListener(a)
          : 0 === a.type
          ? g.F.G(a.Bi, a.YQ, a.fS, a.cf)
          : 1 === a.type &&
            (a.Bi.we || (a.Bi.we = g.va.we),
            g.va.G.call(a.Bi, a.YQ, a.fS, a.cf)));
    },
    O: function (a, b) {
      var c = Array.prototype.slice.call(arguments, 1);
      g.a.Qh(a.O)
        ? a.O.apply(a, c)
        : (a.we || (a.we = g.va.we), g.va.r.apply(a, c));
    },
  };
  g.uF = g.da.extend({
  ...
  z.q.Zb = g.da.extend({
    ...
    setMap: function (a) {
      g.c.add(this, "setMap");
      var b = this.get("map");
      if (a) b && a !== b && b.uk(this), this.set("map", a);
      else if (
        b &&
        (b.uk(this),
        this.set("map", null, !0),
  ...
  z.q.mb = z.q.Zb.extend({
    ...
    A: function (a) {
      ...
      var b = a.zooms;
      b && b[1] >= this.qk[0]
        ? (b[0] < this.qk[0] && (b[0] = this.qk[0]),
          b[1] > this.qk[1] && (b[1] = this.qk[1]))
        : (a.zooms = [this.qk[0], this.qk[1]]);
    ...
    D4: function (a) {
      var b = g.o.VJ;
      g.l.ja &&
        this.get("detectRetina") &&
        (b = g.o.VJ.replace("scl=1", "scl=2"));
    ...
    cg: function (a) {
      var b = this.A2(),
        c = this.get("map");
      this.wq() && this.set("mapNumber", "GS(2023)4677");
      if (this.Wv)
        return new g.q.mb(
          this,
          a,
        ...
        if (((this.Hq = !0), g.q.fi)) {
          if ("dv" === c.get("baseRender") && !this.get("watermark")) {
            var b = c.get("showBuildingBlock"),
              d = new g.q.mb(this, a, this.Ar(this.D4(!b)), void 0, !0);
            b &&
              ((d.Ij = new g.q.qd(
                new z.q.mb({ zooms: [16, 20], innerLayer: !0 }),
                a,
                ["building"]
              )),
              (d.Ij.type = "\u697c\u5757\u56fe\u5c42"),
              d.Ij.bf(["visible", "opacity", "zIndex"], d, !0),
              d.Ij.CC(c.get("mapStyle") || "normal"));
            d.type = "\u6805\u683c\u5e95\u56fe";
            return d;
          }
          if ("v" <= c.get("baseRender") || this.get("watermark"))
            return (
              "3D" == a.D.view.type
                ? ((c = new g.q.qd(this, a, ["region", "road"])),
                  (c.type = "\u77e2\u91cf\u5e95\u56fe"),
                  (b = new z.q.mb({
                    zooms: [17, 20],
                    zIndex: 50,
                  ...
                  (c.Ij = new g.q.qd(b, a, ["building"])),
                  (c.Ij.gf = 17),
                  (c.Ij.type = "\u697c\u5757\u56fe\u5c42"),
                  (c.Ij.az = 1),
                  c.Ij.bf(["visible", "merge", "sort", "opacity"], c, !0),
                  b.X("rejectMapMask", this, !0))
                : ((c = new g.q.qd(this, a, ["region", "building", "road"])),
                  (c.type = "\u77e2\u91cf\u5e95\u56fe")),
              (a.Ema = c)
            );
        } else return ["vectorlayer", "overlay"];
      else return (this.Hq = !1), new g.q.mb(this, a, null, this.w.maxDataZoom);
    },
    ...
    wna: function (a) {
      ...
      g.l.ba && g.l.ja && this.w.detectRetina && !b && (this.qk[1] -= 1);
    },
    getTiles: function () {
      ...
      for (var b = [], c, d = 0; d < a.length; d += 1)
        a[d].key && ((c = a[d].key.split("/")), b.push("" + c[1] + "," + c[2]));
      return b;
    },
    reload: function () {
      g.c.add(this, "reload");
  ...
  z.q.mb.GW = z.q.mb.extend({
    ...
    cg: function (a) {
      if (this.get("map").Ci) {
        ...
        g.l.ja &&
          this.get("detectRetina") &&
          (b = g.o.SK.replace("scl=1", "scl=2"));
        a = new g.q.mb(this, a, this.Ar(b), this.w.maxDataZoom);
      } else (this.Hq = !1), (a = new g.q.mb(this, a));
      return a;
    },
  });
  z.q.mb.RW = z.q.mb.extend({
    w: {
      getTileUrl: function (a, b, c) {
        return (
          g.o.Cc +
          "://tm.amap.com/trafficengine/mapabc/traffictile?v=1.0&t=1&zoom=" +
          (17 - c) +
          "&x=" +
          a +
          "&y=" +
    ...
    cg: function (a) {
      ...
      return "d" !== b.get("baseRender")
        ? g.q.cx
          ? (a = new g.q.cx(this, a))
          : ["vt"]
        : (a = new g.q.mb(this, a, null, this.w.maxDataZoom));
    },
  });
  z.q.mb.AA = z.q.mb.extend({
    ...
    setCreateTile: function (a) {
      ...
      "function" === typeof a &&
        a !== this.get("createTile") &&
        this.set("createTile", a);
    },
  ...
  z.q.mb.Oba = z.q.mb.AA.extend({
    ...
    A: function (a) {
      ...
      this.set("createTile", function (a, d, e, f, h) {
        ...
        k.src =
          this.url + "&TileMatrix=" + e + "&TileRow=" + d + "&TileCol=" + a;
      });
    },
    Dw: function () {
      var a = this.get("url", null, !0),
  ...
  z.q.baa = z.q.Zb.extend({
    ...
    cg: function (a) {
      if (g.l.Yp)
        return (
          (a = new g.q.Kba(this, a)), (a.az = this.get("heightFactor") || 1), a
        );
    },
    setStyle: function (a) {
  ...
  z.q.Xaa = z.q.Zb.extend({
    ...
    A: function (a, b) {
      ...
      g.l.kl &&
        ((this.Aj = !0),
        b.size && (b.size = g.a.Mq(b.size)),
        (this.C = !0),
        this.setData(a),
        g.a.vb(this, b),
        b.style
          ? (this.kf(this.w, !0), this.setStyle(b.style))
          : this.setStyle(this.w),
        (this.C = !1));
    },
    clear: function () {
      g.c.add(this, "clear");
      ...
      if (a instanceof Array) {
        for (var b = 0; b < a.length; b += 1)
          (a[b].rotation_ = (Math.PI * (a[b].rotation || 0)) / 180),
            (a[b].size = g.a.Mq(a[b].size)),
            (a.Bf = Math.max(a.Bf || 0, a[b].size.width + a[b].anchor.x)),
            (a.jg = Math.max(a.Bf || 0, a[b].size.height + a[b].anchor.y));
        this.Em = a;
      } else
        a.size && (a.size = g.a.Mq(a.size)),
          ...
          (this.Em.Bf = this.Em.size.width + this.Em.anchor.x),
          (this.Em.jg = this.Em.size.height + this.Em.anchor.y);
      this.r("style");
    },
    setData: function (a) {
    ...
    setMap: function (a) {
      ...
      g.l.kl &&
        (a
          ? (this.get("map") && this.get("map").uk(this), this.set("map", a))
          : this.get("map") &&
            (this.get("map").uk(this),
            this.set("map", null, !0),
            (this.ri = !1),
            this.hg && this.hg()));
    },
    cg: function (a) {
      return g.ub.KD(["cvector"])
        ? ((a = new g.q.hd(this, a)), this.X("datas", a), a)
        : ["cvector"];
    },
  });
  z.q.haa = z.q.Zb.extend({
    A: function (a) {
    ...
    opacityChanged: function () {
      for (
        var a = this.get("opacity", null, !0), b = -1, c = this.Xm.length;
        ++b < c;

      )
        this.Xm[b].setOpacity(a);
    },
    addLayer: function (a) {
      if (!this.has(a)) {
        a.$A = this;
  ...
  z.q.sr = z.q.Zb.extend({
    ...
    setzIndex: function () {
      var a =
        0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 120;
      this.set("zIndex", a);
      this.w.zIndex = a;
      this.g && this.g.vb(this.w, this.Yf);
    },
        ...
        for (var b = 0; b < a.length; b++) {
          ...
          if (c) {
            ...
            var d = c.w,
              e = {
                data: {
                  ...
                  name: d.title || "",
                  position: this.ufa(d.position) || void 0,
                  rank: d.rank || void 0,
                },
                opts: {
            ...
            d.text &&
              ...
              (d = (d = e.opts.text.style) && d.padding) &&
                (e.opts.text.style.padding = this.zha(d)));
            this.Yf.push(e);
            this.lb.push(c);
    ...
    on: function (a) {
      g.c.add(this, "on");
      this.g ? (this.Dh(arguments), this.g.c2(a)) : this.Qu.push(arguments);
    },
    off: function (a) {
      g.c.add(this, "off");
      this.g && this.g.u$(a);
    ...
    MU: function (a, b) {
      ...
      a &&
        (b
          ? (c && c._LabelMarkerId !== a._LabelMarkerId && c.setTop(!1),
            (this.rP = a))
          : (this.rP = null));
    },
    zR: function (a) {
    ...
    yG: function () {
      var a =
        0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
      return this.Jf(a.width) || this.Jf(a.height)
        ? this.VZ(a)
          ? a.split(",")
          : this.Hga(a)
          ? [a, a]
    ...
    ufa: function () {
      var a =
        0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
      return this.Jf(a.R) || this.Jf(a.Q)
        ? this.VZ(a)
          ? a.split(",")
          : a
        : [a.R, a.Q];
  ...
  z.q.PL = z.q.DA.extend({
    ...
    Vua: function (a) {
      this.get("bounds").contains(a.lnglat) &&
        ((a.target = this), this.r("click", a));
    },
    Wua: function (a) {
      this.get("bounds").contains(a.lnglat) &&
        ((a.target = this), this.r("dblclick", a));
    },
    setMap: function (a) {
      g.c.add(this, "setMap");
      a
        ? (this.get("map") &&
            (this.get("map").uk(this),
            this.K2 && z.event.removeListener(this.K2),
            this.b3 && z.event.removeListener(this.b3)),
          this.set("map", a))
        : this.get("map") && (this.get("map").uk(this), (this.De.map = null));
    },
    mapChanged: function () {
      this.get("map") &&
        (this.get("map").RH(this),
        this.get("clickable") &&
          ((this.K2 = z.event.addListener(
            this.get("map"),
            "click",
            this.Vua,
            this
          )),
          (this.b3 = z.event.addListener(
            this.get("map"),
            "dblclick",
            this.Wua,
            this
  ...
  z.B.Fh = g.da.extend({
    ...
    fR: function (a) {
      ...
      a &&
        (b =
          "string" === typeof a
            ? Math.round(parseFloat(a) / 0.14929107086948487)
            : a);
      return b;
    },
    ...
    setMap: function (a) {
      g.c.add(this, "setMap");
      a !== this.get("map", null, !0) &&
        (a
          ? (this.get("map", null, !0) && this.get("map", null, !0).Lz(this),
            this.set("map", a))
          : this.get("map", null, !0) &&
            (this.get("map", null, !0).Lz(this), this.set("map", null, !0)));
    },
    getMap: function () {
      g.c.add(this, "getMap");
      return this.get("map", null, !0);
  ...
  z.B.hd = z.B.Fh.extend({
    ...
    show: function () {
      g.c.add(this, "show");
      !1 == this.get("visible", null, !0) &&
        (this.set("visible", !0),
        this.r("show", { type: "show", target: this }));
    },
    hide: function () {
      g.c.add(this, "hide");
      !0 == this.get("visible", null, !0) &&
        (this.set("visible", !1),
    ...
    getOptions: function () {
      ...
      var a = {},
        b =
          "map zIndex strokeColor strokeOpacity strokeWeight strokeStyle strokeDasharray extData bubble clickable draggable".split(
            " "
          ),
        c =
          "isOutline outlineColor geodesic path lineJoin lineCap borderWeight showDir dirColor dirImg".split(
            " "
          ),
    ...
    setOptions: function (a) {
      ...
      a.hasOwnProperty("path") &&
        ((a.path && a.path.length) || (a.path = []),
        (a.path = this.Ka(a.path)));
  ...
  z.B.gM = z.B.hd.extend({
    ...
    Q2: function () {
      ...
      this.B &&
        this.B.get("deltaPos") &&
        (a = this.B.Ut(a, this.B.get("deltaPos")));
      return a;
    },
  });
  z.B.di = g.da.extend({
  ...
  z.B.wb = z.B.Fh.extend({
    ...
    mapChanged: function () {
      ...
      a &&
        (this.get("position", null, !0) ||
          this.set("position", a.get("center")),
        a.uC(this),
        this.X("zoom", a));
    },
    getZooms: function () {
    ...
    zoomChanged: function () {
      ...
      if (a) {
        var b = this.get("zoom");
        b < a[0] || b > a[1]
          ? this.set("outOfZooms", !0)
          : this.set("outOfZooms", !1);
        this.B && this.B.rva();
      }
    },
    setIcon: function (a) {
    ...
    moveAlong: function (a, b, c, d) {
      ...
      if (!(2 > a.length)) {
        ...
        for (var e = [a[0]], f = a[0], h = 1; h < a.length; h += 1)
          f.hb(a[h]) || (e.push(a[h]), (f = a[h]));
        this.set("move", { Of: e, speed: b, yb: c, Cna: d });
      }
    },
    stopMove: function () {
  ...
  z.B.Oaa = z.B.Fh.extend({
    ...
    setText: function (a) {
      ...
      if (b) {
        var b = b.Yf,
          c = this.wn(b, this);
        -1 !== c &&
          ((b[c].data.txt = void 0 == a.content ? b[c].data.txt : a.content),
          (b[c].opts.text = g.extend({}, b[c].opts.text, a)),
          a.style &&
            (b[c].opts.text.style = g.extend(
              {},
              b[c].opts.text.style,
              a.style
            )),
    ...
    setTop: function () {
      ...
      a
        ? ((this.Fca = this.w.zIndex), this.setzIndex(this.Zaa))
        : this.setzIndex(this.Fca || this.w.zIndex);
    },
    getVisible: function () {
      g.c.add(this, "getVisible");
  ...
  z.B.Un = z.B.Fh.extend({
    ...
    open: function (a, b) {
      ...
      this.map
        ? this.map &&
          this.map !== a &&
          (this.map.Lz(this), (this.map = a), this.setMap(a))
    ...
    close: function () {
      ...
      this.setMap(null);
      this.map &&
        ((this.map = this.map.vy = null),
        this.r("close", { type: "close", target: this }));
      this.C = !1;
    },
  });
  z.B.Ze = z.B.Fh.extend({
    ...
    open: function (a, b, c) {
      g.c.add(this, "open");
      b = g.a.Ka(b);
      if (a && !this.kL && (b = b || this.get("position", null, !0))) {
        this.r("change", { type: "change", target: this });
        c = this.fR(c) || this.get("altitude");
        var d = this.get("map", null, !0);
        d && d === a
          ? (this.set("altitude", c, !0), this.set("position", b))
          : ((this.map = a),
            a.tm && a.tm.close(),
    ...
    getSize: function (a) {
      ...
      if (b) return b;
      if (this.B && !a)
        return new g.zd(this.B.qh.offsetWidth, this.B.qh.offsetHeight);
    },
    getIsOpen: function () {
  ...
  z.B.$b = z.B.gM.extend({
    ...
    getBounds: function () {
      ...
      if (!a || !a.length) return null;
      for (
        var b = new g.pe(180, 90, -180, -90), c = a.length - 1;
        0 <= c;
        c -= 1
      )
        b.extend(a[c]);
  ...
  (function (a) {
    ...
    function c(a, b, c, d, e) {
      ...
      c = 3 * (d[1] - c[1]) - s;
      return [
        (e[0] - b[0] - f - h) * Math.pow(a, 3) +
          h * Math.pow(a, 2) +
          f * a +
          b[0],
        (e[1] - b[1] - s - c) * Math.pow(a, 3) +
          c * Math.pow(a, 2) +
          s * a +
          b[1],
      ];
    ...
    function h(b, f, h, n, p, q) {
      ...
      if (b && h && h.length) {
        ...
        a: {
          p = Math.min(
            h[1],
            Math.max(h[0], Math.round(Math.max(r, s) / p / q))
          );
          q = null;
          switch (b.length) {
            case 3:
    ...
    a.Nw = {
      ...
      GI: (function () {
        ...
        return function (e, f, h, s) {
          ...
          if (c[v]) return c[v];
          if (e === f && h === s) return b;
          for (var w = d ? new Float32Array(11) : Array(11), t = 0; 11 > t; ++t)
            w[t] = a(0.1 * t, e, h);
          return (c[v] = u);
        };
      })(),
  ...
  z.B.uA = z.B.$b.extend({
    ...
    getSerializedPath: function () {
      ...
      for (
        var a = this.get("path", null, !0), b = [], c = 0, d = a.length;
        c < d;
        c++
      ) {
        var e = a[c];
        if (e instanceof g.U) {
          ...
          if (e.controlPoints)
            for (var h = 0, k = e.controlPoints.length; h < k; h++)
              f.push(e.controlPoints[h].DR()), f.push(e.controlPoints[h].AR());
          f.push(e.DR());
          f.push(e.AR());
          b.push(f);
        } else b.push(e);
    ...
    Ka: function (a) {
      ...
      if (g.a.isArray(a) && "object" === b) {
        for (b = 0; b < a.length; b += 1) a[b] = this.Gja(a[b]);
        return a;
      }
      return [this.xGa(a)];
    },
    Gja: function (a) {
      ...
      if (a instanceof g.U) b = a;
        ...
        if ("string" === b || "number" === b) {
          ...
          for (
            d = a.length, b = new g.U(a[d - 1][0], a[d - 1][1]), c = 0, d -= 1;
            c < d;
            c++
          )
  ...
  z.B.Ec = z.B.gM.extend({
    ...
    eK: function (a) {
      return a.length
        ? a[0] instanceof g.U
          ? [[a]]
          : a[0] instanceof Array && a[0][0] instanceof g.U
          ? [a]
          : a
        : a;
    },
    getArea: function () {
      ...
      for (
        ...
        for (var e = a[c], b = b + this.B4(e[0]), f = 1; f < e.length; f += 1)
          b -= this.B4(e[f]);
    ...
    toString: function () {
      ...
      for (
        var a = this.get("path"), a = this.eK(a), b = [], c = 0, d = a.length;
        c < d;
        c += 1
      ) {
        for (var e = a[c], f = [], h = 0, k = e.length; h < k; h += 1)
          f.push(e[h].join(";"));
        b.push(f.join("|"));
      }
      return b.join("^");
    ...
    getBounds: function () {
      ...
      if (a && a.length) {
        for (
          var a = this.eK(a),
            b = new g.pe(180, 90, -180, -90),
            c = 0,
            d = a.length;
          c < d;
          c += 1
        )
          for (var e = a[c][0], f = e.length - 1; 0 <= f; f -= 1)
            b.extend(e[f]);
        return b;
      }
      return null;
    ...
    contains: function (a) {
      ...
      for (var c = 0, d = b.length; c < d; c += 1) {
        for (
          var e = b[c], f = !1, h = 0, k = e.length;
          h < k &&
          ((f = this.kna(e[h])),
          g.yd.vq(f) || f.reverse(),
          (f = g.yd.Ud(a, f, 0 === h ? !0 : !1)),
          0 < h && (f = !f),
          f);
          h += 1
        );
  ...
  z.B.hh = z.B.hd.extend({
    ...
    A: function (a) {
      ...
      a.center && (a.center = g.a.Ka(a.center));
      a.zIndex = "number" === typeof a.zIndex ? a.zIndex : 10;
      g.a.kk(a.radius, "string") &&
        ((a.radius = parseFloat(a.radius)), isNaN(a.radius) && delete a.radius);
      g.a.vb(this, a);
    ...
    getCenter: function () {
      ...
      this.B &&
        this.B.get("deltaPos") &&
        (a = this.B.Ut([a], this.B.get("deltaPos"))[0]);
      return a;
    },
    reset: function () {
      var a = this.get("center", null, !0);
    ...
    getPath: function (a) {
      ...
      a = a || 36;
      for (
        var b = this.get("center", null, !0),
          c = this.get("radius", null, !0),
          d = [],
          e = 0;
        e < a;
        e += 1
  ...
  z.B.$V = z.B.hh.extend({
    A: function (a) {
      ...
      void 0 === a.radius
        ? (a.radius = 20)
        : g.a.kk(a.radius, "string") &&
          ((a.radius = parseFloat(a.radius)),
          isNaN(a.radius) && (a.radius = 20));
      z.B.$V.cd.A.apply(this, arguments);
    },
    getBounds: function () {
      this.C = !0;
  ...
  var vc = g.da.extend({
    A: function (a) {
      ...
      c =
        a instanceof Array
          ? a
          : a instanceof g.Gl || a instanceof g.Pa
          ? a.elements
          : arguments;
      b[0] = c[0] || 0;
      b[1] = c[1] || 0;
  ...
  (function (a) {
    ...
    b.prototype.set = function (a) {
      if (a.elements !== this.elements)
        return (this.elements = a.elements.slice(0)), this;
    };
    b.prototype.toFixed = function (b) {
      for (var d = this.elements, e = 0; 16 > e; ++e)
        0 !== d[e] && (d[e] = a.a.xb(d[e], b));
      return this;
    };
    ...
    b.prototype.Ixa = function (a) {
      var b, e, f;
      b = a.elements;
      a = this.elements;
      e = [];
      e[0] =
        b[5] * (b[10] * b[15] - b[11] * b[14]) -
        b[9] * (b[6] * b[15] + b[7] * b[14]) +
        b[13] * (b[6] * b[11] - b[7] * b[10]);
      e[4] =
        -b[4] * (b[10] * b[15] - b[11] * b[14]) +
        b[8] * (b[6] * b[15] - b[7] * b[14]) -
        b[12] * (b[6] * b[11] - b[7] * b[10]);
      e[8] =
        b[4] * (b[9] * b[15] - b[11] * b[13]) -
        b[8] * (b[5] * b[15] - b[7] * b[13]) +
        b[12] * (b[5] * b[11] - b[7] * b[9]);
      e[12] =
        -b[4] * (b[9] * b[14] - b[10] * b[13]) +
        b[8] * (b[5] * b[14] - b[6] * b[13]) -
        b[12] * (b[5] * b[10] - b[6] * b[9]);
      e[1] =
        -b[1] * (b[10] * b[15] - b[11] * b[14]) +
        b[9] * (b[2] * b[15] - b[3] * b[14]) -
        b[13] * (b[2] * b[11] - b[3] * b[10]);
      e[5] =
        b[0] * (b[10] * b[15] - b[11] * b[14]) -
        b[8] * (b[2] * b[15] - b[3] * b[14]) +
        b[12] * (b[2] * b[11] - b[3] * b[10]);
      e[9] =
        -b[0] * (b[9] * b[15] - b[11] * b[13]) +
        b[8] * (b[1] * b[15] - b[3] * b[13]) -
        b[12] * (b[1] * b[11] - b[3] * b[9]);
      e[13] =
        b[0] * (b[9] * b[14] - b[10] * b[13]) -
        b[8] * (b[1] * b[14] - b[2] * b[13]) +
        b[12] * (b[1] * b[10] - b[2] * b[9]);
      e[2] =
        b[1] * (b[6] * b[15] - b[7] * b[14]) -
        b[5] * (b[2] * b[15] - b[3] * b[14]) +
        b[13] * (b[2] * b[7] - b[3] * b[6]);
      e[6] =
        -b[0] * (b[6] * b[15] - b[7] * b[14]) +
        b[4] * (b[2] * b[15] - b[3] * b[14]) -
        b[12] * (b[2] * b[7] - b[3] * b[6]);
      e[10] =
        b[0] * (b[5] * b[15] - b[7] * b[13]) -
        b[4] * (b[1] * b[15] - b[3] * b[13]) +
        b[12] * (b[1] * b[7] - b[3] * b[5]);
      e[14] =
        -b[0] * (b[5] * b[14] - b[6] * b[13]) +
        b[4] * (b[1] * b[14] - b[2] * b[13]) -
        b[12] * (b[1] * b[6] - b[2] * b[5]);
      e[3] =
        -b[1] * (b[6] * b[11] - b[7] * b[10]) +
        b[5] * (b[2] * b[11] - b[3] * b[10]) -
        b[9] * (b[2] * b[7] - b[3] * b[6]);
      e[7] =
        b[0] * (b[6] * b[11] - b[7] * b[10]) -
        b[4] * (b[2] * b[11] + b[3] * b[10]) +
        b[8] * (b[2] * b[7] - b[3] * b[6]);
      e[11] =
        -b[0] * (b[5] * b[11] + b[7] * b[9]) +
        b[4] * (b[1] * b[11] - b[3] * b[9]) -
        b[8] * (b[1] * b[7] + b[3] * b[5]);
      e[15] =
    ...
    b.prototype.pva = function (a, d, e, f, h, k) {
      return this.concat(new b().JU(a, d, e, f, h, k));
    };
    b.prototype.Gxa = function (a, b, e, f, h, k) {
      var l, m, n, p;
    ...
    b.prototype.pR = function (a, d, e, f, h, k) {
      return this.concat(new b().Gxa(a, d, e, f, h, k));
    };
    b.prototype.f9 = function (a, b, e, f) {
      var h, k;
    ...
    b.prototype.perspective = function (a, d, e, f) {
      return this.concat(new b().f9(a, d, e, f));
    };
    ...
    b.prototype.$u = function (a) {
      for (var b = 0, e = this.elements.length; b < e; b++)
        if (this.elements[b] !== a.elements[b]) return !1;
      return !0;
    };
  ...
  z.B.Gt = z.B.Ec.extend({
    ...
    mapChanged: function () {
      ...
      !this.ah &&
        this.get("map") &&
        ((this.ah = !0), this.get("map").r("overlays"));
    },
    setCenter: function (a, b) {
      g.c.add(this, "setCenter");
      (a = g.a.Ka(a)) &&
  ...
  z.B.PW = z.B.wb.extend({
    ...
    A: function (a) {
      ...
      g.c.ya(this, a);
      z.B.PW.cd.A.apply(this, arguments);
      this.sga();
      this.C = !0;
    ...
    setText: function (a) {
      g.c.add(this, "setText");
      a || 0 === a || (a = "");
      g.f.Lya(this.lC, "amap-overlay-text-empty", !a);
      g.c.add(this, "setText");
      this.set("text", a);
      this.lC.innerHTML = a;
      this.n8();
  ...
  g.mW = {
    ...
    clear: function () {
      this.Ub(
        0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : g.a.Ts
      );
      this.ix = [];
      return this;
    },
  ...
  (function (a, b) {
    function c(a, b) {
      ...
      for (var c = 0, d = a.length; c < d; c++) {
        var e = a[c];
        if (
          !("*" === b || (e && e.geometry && e.geometry.type === b)) ||
          (e && e.properties && !e.properties._isAmap)
        )
          return !1;
      }
      return !0;
    ...
    a.B.kW = a.B.Xn.extend({
      A: function (c) {
        this.CLASS_NAME = "AMap.GeoJSON";
        b.c.ya(this, c);
        a.B.kW.cd.A.call(this, []);
        this.C = !0;
        this.w = b.extend(
          {
      ...
      importData: function (a) {
        ...
        if (a && ((a = this.nga(a)), a.length)) {
          this.clearOverlays();
          this.uC(a);
          var c = this.w.map;
          if (c)
            for (var d = 0, e = a.length; d < e; d++)
              (a[d].C = !0), a[d].setMap(c), (a[d].C = !1);
        }
      },
      toGeoJSON: function () {
        b.c.add(this, "toGeoJSON");
        for (var a = this.ZI(), c = [], d = 0, e = a.length; d < e; d++)
          (a[d].C = !0), (c[d] = a[d].toGeoJSON()), (a[d].C = !1);
        return c;
      },
      nga: function (a) {
        if (a) {
      ...
      eda: function (c) {
        for (
          var d = "Feature" === c.type ? c.geometry : c,
            d = d ? d.coordinates : null,
            e = [],
            f = 0,
            n = d.length;
          f < n;
          ...
          e.push(
            this.IX(
              b.extend({}, c, {
                ...
                geometry: { type: "Point", coordinates: d[f] },
              })
            )
          );
        d = new a.B.Xn(e);
      ...
      JX: function (a) {
        for (
          ...
          c.push(this.w.coordsToLatLngs(b[d]));
      ...
      Yca: function (c) {
        for (
          var d = ("Feature" === c.type ? c.geometry : c).geometries,
            e = [],
            f = 0,
            n = d.length;
          f < n;
        ...
        if (b)
          switch (b.type) {
            ...
            case "FeatureCollection":
              for (
                var c = b.features, d = [], e = 0, f = c.length;
                e < f;
                e++
              ) {
                var p = this.PN(c[e]);
    ...
    a.B.Xn.Ib({
      toGeoJSON: function (a) {
        ...
        for (var e = [], f = 0, m = a.length; f < m; f++)
          a[f].toGeoJSON &&
            ((a[f].C = !0), (e[f] = a[f].toGeoJSON()), (a[f].C = !1));
        this.C = !0;
        a = this.getExtData() || {};
        this.C = !1;
        if (c(e, "Point"))
          ...
          for (var f = [], m = 0, n = e.length; m < n; m++)
            f.push(e[m].geometry);
          e = {
            type: "Feature",
            properties: a,
  ...
  g.yd = {
    os: function (a, b) {
      for (var c = Infinity, d = 0, e = 1, f = b.length; e < f; d = e, e += 1)
        c = Math.min(c, g.yd.dya(a, [b[d], b[e]]));
      return Math.sqrt(c);
    },
    dya: function (a, b) {
      return this.dL(a, this.L2(a, b));
    },
    dL: function (a, b) {
      var c = a[0] - b[0],
        d = a[1] - b[1];
    ...
    NGa: function (a, b, c, d) {
      ...
      return (
        Math.abs(
          ((c[1] - b[1]) / (c[0] - b[0])) * (a[0] - b[0]) + b[1] - a[1]
        ) < d &&
        a[0] >= e &&
        a[0] <= f
      );
    ...
    L2: function (a, b) {
      var c = a[0],
        ...
        c =
          0 === l && 0 === m
            ? 0
            : (l * (c - h) + m * (d - e)) / (l * l + m * m || 0);
      0 >= c || (1 <= c ? ((h = k), (e = f)) : ((h += c * l), (e += c * m)));
      return [h, e];
    },
    vq: function (a) {
      for (
        var b = a.length, c = 0, d = a[b - 1], e = d[0], d = d[1], f, h, k = 0;
        k < b;
        k += 1
      )
        (h = a[k]),
  ...
  (function (a) {
    ...
    function c() {
      return {
        ...
        ringArea: function (a) {
          for (
            var b = [0, 0], c = [0, 0], d = 0, e = a[0], n = a.length, p = 2;
            p < n;
            p++
          ) {
            var q = a[p - 1],
    ...
    function d(a) {
      for (var b = 0, c = a.length, d = 0; d < c - 1; d++)
        var e = a[d], n = a[d + 1], b = b + (n[0] - e[0]) * (n[1] + e[1]);
      if (a[c - 1][0] !== a[0][0] || a[c - 1][1] !== a[0][1])
        (e = a[c - 1]), (n = a[0]), (b += (n[0] - e[0]) * (n[1] + e[1]));
      return 0 >= b;
    }
    function e(b) {
      this.CLASS_NAME = "AMap.GeometryUtil";
      this.Wb = a.extend(
        { onSegmentTolerance: 5, crs: "EPSG3857", maxZoom: 20 },
        b
      );
    ...
    a.extend(e.prototype, {
      ...
      Ix: function (a, b) {
        ...
        !0 === b
          ? (c = this.makesureClockwise(c))
          : !1 === b && ((c = this.makesureClockwise(c)), c.reverse());
        return c;
      },
      kka: function (a) {
        for (var b = [], c = 0, d = a.length; c < d; c++)
      ...
      closestOnSegment: function (b, c, d) {
        b = a.yd.L2(this.project(b), this.Ix([c, d]));
      ...
      isPointInPolygon: function (a, b) {
        ...
        for (
          ...
          d < e && ((c = this.isPointInRing(a, b[d])), 0 < d && (c = !c), c);
          d += 1
        );
        return c;
      },
      ...
      doesPolygonPolygonIntersect: function (a, b) {
        return this.doesRingRingIntersect(b, a) ||
          this.isRingInRing(a, b) ||
          this.isRingInRing(b, a)
          ? !0
          : !1;
      },
      doesPolygonContainsPolygon: function (a, b, c) {
        return (
          this.isRingInRing(b, a, !0) ||
          (c ? this.doesRingRingIntersect(b, a, !0) : !1)
        );
      },
        ...
        for (var c = 0, d = 0; d < a.length - 1; d += 1) {
          ...
          if (e + c < b) c += e;
            ...
            return (
              (c = (b - c) / e),
              [
                a[d][0] + c * (a[d + 1][0] - a[d][0]),
                a[d][1] + c * (a[d + 1][1] - a[d][1]),
                d,
              ]
            );
        }
    ...
    (function () {
      function b(a) {
        for (var b = 0, e = a.length, f = 0; f < e - 1; f++)
          var h = a[f], k = a[f + 1], b = b + (k[0] - h[0]) * (k[1] + h[1]);
        if (a[e - 1][0] !== a[0][0] || a[e - 1][1] !== a[0][1])
          (h = a[e - 1]), (k = a[0]), (b += (k[0] - h[0]) * (k[1] + h[1]));
        return 0 >= b;
      }
      a.Vta = function (a) {
    ...
    (function () {
      ...
      a.Wh = function (a, e) {
        ...
        for (var n = 0; n < e.length; n++)
          l.push(m), (m += e[n].length), c(k, e[n]);
        l = (this.oL ? this.oL : g.Fc.oL)(k, l);
        if (h) {
          f = [];
          for (n = 0; n < l.length; n += 1)
            (h = 2 * l[n]), f.push([k[h], k[h + 1]]);
          return f;
        }
    ...
    a.tF = function () {
      ...
      function c(a, b) {
        ...
        var c = a,
          d;
        do
          if (((d = !1), c.A9 || (!m(c, c.next) && 0 !== l(c.Ia, c, c.next))))
            c = c.next;
          else {
            s(c);
            c = b = c.Ia;
          ...
          for (D = a; a.Ia !== a.next; ) {
            ...
            if (u)
              a: if (((H = a.Ia), (I = a.next), 0 <= l(H, a, I))) H = !1;
                ...
                P = h(
                  H.x < a.x ? (H.x < I.x ? H.x : I.x) : a.x < I.x ? a.x : I.x,
                  H.y < a.y ? (H.y < I.y ? H.y : I.y) : a.y < I.y ? a.y : I.y,
                  f,
                  r,
                  u
                );
                ...
                for (B = a.pl; B && B.z <= M; ) {
                  if (
                    B !== a.Ia &&
                    B !== a.next &&
                    k(H.x, H.y, a.x, a.y, I.x, I.y, B.x, B.y) &&
                    0 <= l(B.Ia, B, B.next)
                  ) {
                    H = !1;
                    break a;
              ...
              a: if (((H = a.Ia), (I = a.next), 0 <= l(H, a, I))) H = !1;
                ...
                for (P = a.next.next; P !== a.Ia; ) {
                  if (
                    k(H.x, H.y, a.x, a.y, I.x, I.y, P.x, P.y) &&
                    0 <= l(P.Ia, P, P.next)
                  ) {
                    H = !1;
                    break a;
      ...
      function f(a, b) {
        ...
        if (d === f) return h.Ia;
        for (
          var l = h, m = h.x, n = h.y, r = Infinity, s, c = h.next;
          c !== l;
          ...
          d >= c.x &&
            c.x >= m &&
            d !== c.x &&
            k(e < n ? d : f, e, m, n, e < n ? f : d, e, c.x, c.y) &&
            ((s = Math.abs(e - c.y) / (d - c.x)),
            (s < r || (s === r && c.x > h.x)) && p(c, a) && ((h = c), (r = s))),
            (c = c.next);
        return h;
      }
      ...
      function p(a, b) {
        return 0 > l(a.Ia, a, a.next)
          ? 0 <= l(a, b, a.next) && 0 <= l(a, a.Ia, b)
          : 0 > l(a, b, a.Ia) || 0 > l(a, a.next, b);
      }
      function q(a, b) {
      ...
      function r(a, b, c, d) {
        a = new u(a, b, c);
        d
          ? ((a.next = d.next), (a.Ia = d), (d.next.Ia = a), (d.next = a))
          : ((a.Ia = a), (a.next = a));
        return a;
      }
      function s(a) {
      ...
      function u(a, b, c) {
        ...
        this.x = b;
        this.y = c;
        this.pl = this.kp = this.z = this.next = this.Ia = null;
        this.A9 = !1;
      }
      return {
        oL: function (h, k, l) {
    ...
    d.h(
      ...
      function (a) {
        if ("1" === a.status) {
          ...
          c &&
            "function" === typeof c &&
            c("complete", { info: "ok", locations: a });
  ...
  g.kb.lM = g.da.extend({
    ...
    A: function (a, b) {
      ...
      g.a.vb(this, b);
      this.url = a;
      this.send(a, b.Gd, b.T2, b.tU, b.responseType);
    },
    send: function (a) {
  ...
  g.kb.Ab = g.kb.lM.extend({
    qna: function () {
      if (g.a.V8) return g.a.fL.push(this), !0;
    },
    exa: function () {
    ...
    send: function (a, b, c, d) {
      ...
      if (!this.w.jy || !this.qna()) {
        a = encodeURI(a);
        var f = this.w.fun;
        if (!f || window[f]) f = g.a.k4("jsonp_", 6) + "_";
        ...
        if (
          -1 !== a.indexOf(g.o.fd + "/v") ||
          -1 !== a.indexOf("yuntuapi.amap.com/datasearch") ||
          -1 !== a.indexOf("webapi.amap.com/")
        )
          (b = b + "&platform=JS&logversion=2.0" + ("&appname=" + g.o.Ao)),
            (b += "&csid=" + g.a.kr()),
            (b += "&sdkversion=" + g.o.Xl);
        if ((c = this.w.II)) {
          var l = [],
  ...
  g.kb.XMLHttpRequest = g.kb.lM.extend({
    send: function (a, b, c, d, e) {
      var f = this;
      if ((g.l.Ve || g.l.o5) && window.XDomainRequest) {
        var h = (this.Q$ = new XDomainRequest());
        ...
        var k = (this.Q$ = new XMLHttpRequest());
        k.onreadystatechange = function () {
          4 === k.readyState && 200 === k.status
            ? f.r("complete", {
                url: a,
                data:
                  "arraybuffer" === k.responseType || "json" === k.responseType
                    ? k.response
                    : k.responseText,
              })
            : 404 === k.status &&
              (k.abort(), f.r("error", { url: a, data: "404" }));
        };
  ...
  for (
    var $ = {
      ...
      Jc =
        "addDomListener addDomListenerOnce addListener addListenerOnce clearInstanceListeners clearListeners removeListener trigger".split(
          " "
        ),
      Kc = 0;
    Kc < Jc.length;
  ...
  for (Kc = 0; Kc < Lc.length; Kc += 1)
    $.PlaneGeometryUtil[Lc[Kc]] = (function () {
      var a = g.ei[Lc[Kc]],
        b = Lc[Kc];
      return function () {
  ...
  $.TileLayer.Satellite = z.q.mb.JW;
  $.TileLayer.RoadNet = z.q.mb.GW;
  $.TileLayer.google = z.q.mb.OL;
  $.TileLayer.Flexible = z.q.mb.AA;
  $.TileLayer.WMS = z.q.mb.Nba;
  $.TileLayer.WMTS = z.q.mb.Oba;
  $.TileLayer.Traffic = z.q.mb.RW;
  ...
  $.Browser = {
    ...
    mobileWebkit: g.l.rua,
    mobileWebkit3d: g.l.M6,
    mobileOpera: !!g.l.qua,
    retina: g.l.Kc,
    touch: !!g.l.Uf,
    msPointer: !!g.l.O6,
  ...
  for (Kc in Mc)
    Mc.hasOwnProperty(Kc) &&
      "function" == typeof Mc[Kc] &&
      ($.Util[Kc] = (function () {
        var a = Kc;
        return function () {
          g.c.ya($.Util);
  ...
  for (Kc in Nc)
    Nc.hasOwnProperty(Kc) &&
      "function" == typeof Nc[Kc] &&
      ($.DomUtil[Kc] = (function () {
        var a = Kc;
        return function () {
          g.c.ya($.DomUtil);
  ...
  g.Lj = g.da.extend({
    ...
    On: function (a) {
      ...
      this.Xia = g.a.bind(this.Kq, a || this);
    },
    update: function () {
      this.frames += 1;
      var a = +new Date(),
        b = a - this.startTime,
        b = this.transition
          ? this.transition(this.start, this.end, b, this.frames, a - this.ih)
          : null;
      "number" === typeof b && Math.abs(b - this.end) < this.precision
        ? (this.stop(), (b = this.end))
        : (this.zo = g.a.Xc(this.update));
      this.ih = a;
      this.Xia(b);
    },
  ...
  g.Sb = g.da.extend({
    ...
    A: function (a, b) {
      ...
      if (g.l.eL) {
        ...
        this.Hc.S.h("complete", this.Dr, this, !0);
      ...
      this.X("draw", b);
      this.bf(
        "zoomAndCenter destroy defaultCursor jogEnable animateEnable baseRender overlayRender vectorMapForeign".split(
          " "
        ),
        b
      );
      this.bf(
        "rotateEnable pitchEnable dragEnable keyboardEnable doubleClickZoom scrollWheel zoomEnable touchZoom".split(
          " "
        ),
        b,
        !0
          ...
          if ("normal" === c)
            ...
            b.h(
              ...
              function (a) {
                a.data &&
                  a.data.layer &&
                  this.set("layerStyle", JSON.parse(a.data.layer));
    ...
    sna: function () {
      ...
      if (!a.contains(b)) {
        if (b instanceof g.vp) return this.sqa(a, b);
        var c = this.get("center").eb();
        a.wj() < b.wj()
          ? (c.R = a.yi().R)
          : (a.wc.R > b.wc.R && (c.R += a.wc.R - b.wc.R),
            a.oc.R < b.oc.R && (c.R += a.oc.R - b.oc.R));
        a.uj() < b.uj()
          ? (c.Q = a.yi().Q)
          : (a.wc.Q > b.wc.Q && (c.Q += a.wc.Q - b.wc.Q),
    ...
    ZO: function () {
      ...
      b &&
        ...
        this.set("display"),
        this.E8(b),
        this.get("resizeEnable") && this.qa("resize", { Kua: a, Y6: b }));
    },
    r0: function () {
      var a = this;
      a.ZO();
    ...
    bha: function () {
      ...
      this.D.C = !1;
      if (g.l.Ve || (g.l.I$ && g.l.GD) || g.l.eua) this.r0();
      else {
        var a = this;
        g.F.dma(this.K, function (b) {
          a.ZO(b);
        });
      }
    },
    Asa: function () {
      ...
      g.f.create("img", b.aT).src = g.l.Kc
        ? this.D.w.logoUrlRetina
        : this.D.w.logoUrl;
      b.sn = g.f.create("div", a, "amap-copyright");
      b.sn.style.display = "none";
      350 < g.f.nJ(this.K).width &&
        ((b.sn.innerHTML = this.D.w.copyright),
        (b.sn.B6 = g.f.create("span", b.sn, "amap-mcode")),
        this.vE());
      this.Ya = b;
    },
    vE: function () {
      ...
      if (a) {
        ...
        "GS(2023)4677" === c &&
          a &&
          "normal" !== a &&
          "amap://styles/normal" !== a &&
          ((c = ""), (this.Ya.sn.style.visibility = "hidden"));
        c &&
          this.Ya.sn.B6 &&
          ((this.Ya.sn.B6.innerHTML = "- " + c + "\u53f7"),
          (this.Ya.sn.style.visibility = "visible"));
        return c;
      }
    },
    EY: function () {
    ...
    Dr: function () {
      function a() {
        for (
          var a = d.get("layers"), b = d.get("zoom"), c = 0;
          c < a.length;
          c += 1
        ) {
          var e = a[c].get("zooms");
          if (
            !(
              ...
              b < e[0] ||
              !a[c].get("visible") ||
              (a[c].q && a[c].q.ha && 0 === a[c].q.ha.length) ||
              (a[c].q && a[c].q.ZD) ||
              (a[c].q && a[c].q.Ra)
            )
          )
      ...
      if (!this.xI)
        if (this.QS) this.EY();
          ...
          var d = this,
            ...
            f = a();
          e
            ? (e.q && e.q.Ra && (this.D.Ra || c()),
              f && (this.D.Ra || c(), this.gU(), b()))
            : f && (this.D.Ra || c(), b(), (this.D.j8 = !0));
        }
    },
    layersChanged: function () {
      this.la = this.la || [];
      for (var a = this.get("layers"), b = this.la.length - 1; 0 <= b; b -= 1)
        this.la[b] === this.vd ||
          this.la[b] === this.at ||
          this.la[b].AB ||
          this.la[b].S.AB ||
          -1 !== g.a.indexOf(a, this.la[b].S) ||
          (this.la[b].hg(),
          this.la[b].Ij && this.la[b].Ij.hg(),
          this.la[b].S.G("complete", this.Dr, this),
          this.la[b].S.G("renderComplete", this.Dr, this),
          (this.la = g.a.Ho(this.la, b)));
      for (
        var c = !1, d = !0, e = this.get("labelzIndex"), b = 0;
        b < a.length;
        b += 1
      )
        if (!a[b].x5)
          if (a[b].ri)
            -1 === g.a.indexOf(this.la, a[b].q) && this.la.push(a[b].q);
          else {
            var f = this.cg(a[b]);
      ...
      c && this.D.get("showLabel")
        ? (-1 === a && this.la.push(this.Hc),
          (this.Hc.ja = d && g.l.ja),
          this.Hc.CC(this.get("mapStyle") || "normal"),
          this.Hc.set("zIndex", e),
          this.Hc.set("visible", !0),
          (this.D.wD = !0),
          this.D.get("isHotspot") ? this.Hc.cva() : this.Hc.lQ())
        : (this.Hc &&
            (this.Hc.set("visible", !1), (this.D.wD = !1), this.Hc.lQ()),
          (this.D.wD = !1));
    ...
    controlsChanged: function () {
      ...
      if (a.add && 0 < a.add.length)
        for (; 0 < a.add.length; )
          (b = a.add.shift()),
            (c = b.zu || b.addTo) && c.call(b, this.D, this.Ya.controls);
      else if (a.remove && a.remove.length)
        for (; 0 < a.remove.length; )
          (b = a.remove.shift()),
            (c = b.Yv || b.removeFrom) && c.call(b, this.D, this.Ya.controls);
    },
    E1: function () {
      if (!this.xI) {
        var a = this;
        this.J1 = !1;
        a.vd ||
          ((a.vd = new g.q.hd(new z.q.hd(), a)),
          (a.vd.Bf = 36),
          (a.vd.jg = 36),
          a.vd.set("zIndex", 120),
          a.la.push(a.vd),
          (a.vd.YC = !0));
        for (var b = a.get("overlays"), c = [], d = 0; d < a.Wc.length; d += 1)
          -1 === g.a.indexOf(b, a.Wc[d].Mb) &&
            (a.Wc[d].Mb instanceof z.B.Ze || a.Wc[d].Mb instanceof z.B.Un
              ? a.Wc[d].hg()
              : (a.vd && a.Wc[d] instanceof g.B.wb
                  ? ((a.vd.bh = g.a.Ey(a.vd.bh, a.Wc[d].L)),
                    a.vd.q8([a.Wc[d].L]))
                  : a.at && a.at.q8([a.Wc[d].L]),
                a.Wc[d].L.fa
                  ? (g.f.remove(a.Wc[d].L.fa), (a.Wc[d].L.fa = null))
                  : a.Wc[d].L.Ma &&
                    (g.f.remove(a.Wc[d].L.Ma.Ph),
                    g.f.remove(a.Wc[d].L.Ma.Rc),
                    g.f.remove(a.Wc[d].L.Ma.dir),
                    (a.Wc[d].L.Ma = null)),
                a.Wc[d].Hn && a.Wc[d].Hn.stop(),
                a.Wc[d].zh && a.Wc[d].zh.stop(),
                (a.Wc[d].Mb.ri = !1),
                a.Wc[d].Mb.zl(),
                (a.Wc[d].Mb.B = null),
                (a.Wc[d].Mb = null),
        ...
        for (d = 0; d < c.length; d += 1)
          a.Wc = g.a.Ho(a.Wc, g.a.indexOf(a.Wc, c[d]));
        var e = [],
          f = [];
        g.a.vxa(function (b) {
          if (!b.ri && b.ah) {
            ...
            c &&
              (a.Wc.push(c),
              c instanceof g.B.Ze || c instanceof g.B.Un
                ? c.Vs(a)
                : c instanceof g.B.wb
                ? e.push(c.L)
                : f.push(c.L),
    ...
    overlaysChanged: function () {
      ...
      this.get("overlays") && 0 === this.get("overlays").length
        ? this.E1()
        : this.J1 || (g.a.Xc(this.E1, this), (this.J1 = !0));
    },
    ...
    infosChanged: function () {
      ...
      if (a) {
        ...
        g.ub.load("overlay", function () {
          for (var d in a)
            a.hasOwnProperty(d) &&
              ((b = a[d]), (c.tm[d] = c.tm[d] || new g.B.Ze(b, c)));
        });
      }
    },
    Yma: function (a) {
      ...
      if (a instanceof z.B.wb) b = new g.B.wb(a, this);
        ...
        "d" === this.get("overlayRender")
          ? (c.push("dvector"), g.l.Fn ? c.push("svg") : c.push("vml"))
          : c.push("cvector");
        if (!this.Sza && !g.ub.KD(c)) {
          var d = this;
          g.ub.Gg(c, function () {
            this.Sza = !0;
            d.overlaysChanged();
    ...
    S3: function () {
      var a = this.Ee;
      this.Pu &&
        (!this.Se || !this.Se.Jp || (this.D && this.D.ls)) &&
        (a = "function" === typeof this.Pu ? this.Pu(this.wi.P.zoom) : this.Pu);
      return a;
    },
    QCa: function () {
      function a() {}
    ...
    pc: function () {
      ...
      if (!this.xI) {
        ...
        if (
          this.la &&
          ((a.size = this.D.get("size")), a.size.width && a.size.height)
        ) {
          for (
            var b = this.D.view.type, c = [], d = 0, e = this.la.length;
            d < e;
            d += 1
          )
            this.la[d].Vf && this.la[d].Vf !== b
              ? (this.la[d].Ra = !0)
              : (c.push(this.la[d]), this.la[d].Ij && c.push(this.la[d].Ij));
          c.sort(function (a, b) {
            var c = a.get("zIndex"),
              d = b.get("zIndex");
          ...
          a.b2 = 15e5 < a.size.width * a.size.height * c * c;
          ...
          a.zua = !0;
          a.YH = this.YH;
          for (var b = !1, f, c = !1, d = 0; d < this.la.length; d += 1)
            this.la[d].Ei &&
              this.la[d].S.get("visible") &&
              a.P.zoom <= this.la[d].S.get("zooms")[1] &&
              (a.lU = !0),
              this.la[d].ne().Kc && (b = !0);
          for (d = 0; d < this.la.length; d += 1)
            this.la[d].S.QP &&
              a.lU &&
              (!this.fj &&
                this.la[d].S.get("visible") &&
                ((f = this.la[d].S.QP()), (f.rFa = 1), (f.zoom = a.P.zoom)),
              (c = !0));
          this.pb = [];
    ...
    Qq: function (a) {
      if (!this.xI) {
        ...
        if (
          this.la &&
          ((b.size = this.D.get("size")), b.size.width && b.size.height)
        ) {
          for (
            var c = this.D.view.type, d = [], e = 0, f = this.la.length;
            e < f;
            e += 1
          )
            (this.la[e].Vf && this.la[e].Vf !== c) ||
              !(this.la[e] instanceof g.q.Pm) ||
              0 > a.indexOf(this.la[e].S) ||
              (d.push(this.la[e]), this.la[e].Ij && d.push(this.la[e].Ij));
          d.sort(function (a, b) {
            var c = a.get("zIndex"),
              d = b.get("zIndex");
            return c > d ? 1 : c === d ? (a.hx > b.hx ? 1 : -1) : -1;
          ...
          b.b2 = 15e5 < b.size.width * b.size.height * a * a;
    ...
    Ry: function () {
      if (!this.J || this.J.type !== this.D.view.type || this.J.Uta)
    ...
    destroyChanged: function () {
      ...
      this.V = {};
      this.Hc &&
        (this.Hc.S.G("complete", this.Dr, this),
        this.Hc.hg(),
        (this.la = g.a.Ho(this.la, g.a.indexOf(this.la, this.Hc))));
      this.Se && this.Se.je && this.Se.je.S && this.Se.je.S.setMap();
      this.Vka && clearTimeout(this.Vka);
      this.zka();
      this.Cha();
      this.CO && this.CO();
      this.Fla();
    ...
    drawChanged: function () {
      ...
      if (d) {
        this.uq || (this.uq = []);
        b = 0;
        for (c = this.uq.length; b < c; b += 1) this.uq[b].Ewa();
        ...
        for (b = 0, c = this.uq.length; b < c; b += 1)
          this.uq[b].Ewa(),
            this.uq[b].mDa(),
            this.G("click", this.uq[b].ZEa, this);
    },
    Zd: function (a, b, c) {
      ...
      for (l = 0; l < k.length; l += 1) {
        ...
        if (
          ...
          if ("CANVAS" === m.tagName) {
            ...
            for (
              var r = m.childNodes,
                s = parseFloat(m.style.top) || 0 + c,
                m = parseFloat(m.style.left) || 0 + e,
                u = 0;
              u < r.length;
              u += 1
            ) {
  ...
  g.Sb.Ib({
    rga: function () {
      this.FB = !1;
      g.l.Uf && ("3D" === this.D.view.type ? this.Oca() : this.Mca());
      g.l.ba || this.Jca();
    },
    zka: function () {
      g.l.Uf && ("3D" === this.D.view.type ? this.Hha() : this.Gha());
      g.l.ba || (this.Dha(), this.r_());
    },
    rotateEnableChanged: function () {
      this.lxa = this.get("rotateEnable");
      g.l.Uf &&
        this.d2 &&
        "3D" !== this.D.view.type &&
        (this.lxa ? this.d2() : this.Jua());
    },
    zoomEnableChanged: function () {
      this.get("zoomEnable")
        ? (g.l.Uf && this.SP && "3D" !== this.D.view.type && this.SP(),
          g.l.ba || this.Lca())
        : (g.l.Uf && this.lT && this.lT(), g.l.ba || this.r_());
    },
    ...
    Mi: function (a, b, c, d) {
      ...
      g.l.Uf && ("touchend" !== a.type ? (this.V.Xga = h) : (h = this.V.Xga));
      f.Db = h;
      f.Ta = this.zg(h);
      f.Ta && (f.Ta = f.Ta.toFixed(3));
      f.Of = this.Qd(f.Ta);
      c ||
        ((c = this.FB ? (this.FB ? [this.FB] : null) : this.hfa(f.Ta, d)) &&
          0 < c.length &&
          c[0].vo &&
          ((e = c[0].vo), (f.uu = c[0])));
      e || "info" === a.af || (e = this);
    ...
    UO: function () {
      var a = this.V;
      a.gg &&
        (a.bk.Db.x === a.gg.x && a.bk.Db.y === a.gg.y
          ? (a.Kf = !1)
          : ((a.Kf = !0),
            a.Gp || (a.kq.r("dragstart", a.jq), (a.Gp = !0)),
            a.kq.r("dragging", a.bk),
            (a.gg = a.bk.Db)));
    },
    bya: function (a) {
      for (var b = [], c = 0; c < a.length; c += 1)
    ...
    Sv: function (a, b, c) {
      return (
        a &&
        b &&
        (a.x - b.x) * (a.x - b.x) + (a.y - b.y) * (a.y - b.y) < (c || 10)
      );
    },
    hfa: function (a, b) {
      var c = this.Ry();
  ...
  g.Sb.Ib({
    yga: function () {
      this.Vm = {};
      this.h("moveend", this.m7, this);
      g.l.Zl && (g.l.tL || g.l.XH) && this.h("zoomend", this.MV, this);
      this.h("movestart", this.n7, this);
      this.h("zoomstart", this.u7, this);
      this.h("zoomend", this.t7, this);
      this.JM();
      this.jB = 0;
      this.JY = {};
    ...
    u7: function () {
      2 !== this.jB &&
        12 === this.get("zoom") &&
        ((this.jB = 1), g.a.lR.start(this.JY));
      this.fj = !0;
    },
    t7: function () {
      1 === this.jB &&
        13 !== this.get("zoom") &&
        ((this.jB = 0), g.a.lR.cancel(this.JY));
      this.fj = !1;
      this.set("display");
    },
    $0: function (a, b) {
    ...
    Cha: function () {
      this.G("moveend", this.m7, this);
      g.l.Zl && (g.l.tL || g.l.XH) && this.G("zoomend", this.MV, this);
      this.G("movestart", this.n7, this);
      this.G("zoomstart", this.u7, this);
      this.G("zoomend", this.t7, this);
      this.Eha();
    },
    m7: function (a) {
      this.Kf = !1;
      this.ou();
      this.E8();
      !a.S5 && this.D.get("limitBounds", null, !0)
        ? (a = this.sna()) && !a.hb(this.get("center"))
          ? this.YK(this.get("zoom"), a, !1, !0)
          : this.qa("moveend")
        : this.qa("moveend");
      this.set("display");
    },
    ...
    qa: function (a, b) {
      if (this.D.we(a)) {
        ...
        b &&
          (c = b.Y6
            ? { type: a, newsize: b.Y6, oldsize: b.Kua }
            : {
                type: a,
                pixel: b.Db,
                target: this.D,
    ...
    JM: function () {
      this.h("click", this.D_);
      this.h("dblclick", this.H_);
      g.l.Uf && this.BX();
      g.l.ba || this.Kca();
    },
    Eha: function () {
      this.G("click", this.D_);
      this.G("dblclick", this.H_);
      g.l.Uf && this.s_();
      g.l.ba || this.Fha();
    },
    eH: function (a, b) {
      ...
      c === this.get("zoom") ||
        (this.Wf && this.Wf.dw && c === this.Wf.end) ||
        this.sA(c, !1, a);
    },
    D_: function (a) {
      this.qa("click", a);
    ...
    IM: function () {
      this.ZC &&
        ("3D" === this.D.view.type
          ? (this.h("dragstart", this.N_),
            this.h("dragging", this.J_),
            this.h("dragend", this.L_))
          : (this.h("dragstart", this.M_),
            this.h("dragging", this.I_),
            this.h("dragend", this.K_)));
    },
    BO: function () {
      this.ZC ||
        ("3D" === this.D.view.type
          ? (this.G("dragstart", this.N_),
            this.G("dragging", this.J_),
            this.G("dragend", this.L_))
          : (this.G("dragstart", this.M_),
            this.G("dragging", this.I_),
            this.G("dragend", this.K_)));
    },
    M_: function (a) {
      this.ZS(a);
      this.ou();
    ...
    I_: function () {
      ...
      if (c || b) {
        ...
        (d = this.C2(a)) && (c = Math.round(this.Zd(d).bb(this.Zd(a)).y));
        ...
        this.yv &&
          (this.ih
            ? ((a = new Date()),
              (this.$t = 100 < a - this.ih ? new g.H(0, 0) : new g.H(b, c)),
              (this.ih = a))
            : (this.ih = new Date()));
        this.qa("dragging");
        this.qa("mapmove");
    ...
    ap: function (a, b, c) {
      if (a && !(1 > Math.abs(b) && 1 > Math.abs(c))) {
        ...
        a.style.cssText =
          "position:absolute;top:" + (d + c) + "px;left:" + (e + b) + "px;" + f;
      }
    },
    C2: function (a) {
      var b = this.D.view.dX(),
        c = (this.SU.height * this.T) / 2;
      return a.y < b.hc + c
        ? ((a.y = b.hc + c), a)
        : a.y > b.tc - c
        ? ((a.y = b.tc - c), a)
    ...
    MV: function () {
      if (g.l.Zl && (g.l.tL || g.l.XH)) {
        ...
        for (b = 0; b < this.la.length; b += 1)
          (c = this.la[b]),
            "undefined" !== typeof AMap.IndoorMap &&
    ...
    ws: function (a) {
      this.V.refresh &&
        (clearInterval(this.V.refresh), (this.V.refresh = null));
    ...
    boa: function () {
      ...
      if (this.get("center") instanceof g.U) {
        ...
        (a = this.map.get("limitBounds", null, !0)),
          (this.zM = { Jc: a[0], hc: a[1], Ic: a[2], tc: a[3] });
    },
    tD: function () {
      var a = this.map,
        b = this.get("zoom");
  ...
  g.PF = g.TW.extend({
    lm: function () {
      var a = this.get("size"),
        ...
        c = (Math.PI * c) / 180,
        a = new g.H(
          (Math.abs(a.width * Math.cos(c)) + Math.abs(a.height * Math.sin(c))) /
            2,
          (Math.abs(a.width * Math.sin(c)) + Math.abs(a.height * Math.cos(c))) /
            2
        ),
      ...
      if (c > d - 1) {
        ...
        e.T$ = new g.Xf(b.bb(a.Pd(f)), b.add(a.Pd(f)));
      }
      e.L9 = c || d;
      e.Ac = a;
      return e;
    ...
    uqa: function (a) {
      var b = this.get("size"),
        ...
        d = (Math.PI * d) / 180,
        b = new g.H(
          (Math.abs(b.width * Math.cos(d)) + Math.abs(b.height * Math.sin(d))) /
            2,
          (Math.abs(b.width * Math.sin(d)) + Math.abs(b.height * Math.cos(d))) /
            2
        );
      a = Math.pow(2, 20 - a);
    ...
    zg: function (a, b) {
      var c = this.get("size").RE().nd(2),
        ...
        c = this.get("centerCoords").add(
          new g.H(c, d).Pd(Math.pow(2, 20 - (b || this.get("zoom"))))
        );
      c.x = (c.x + 268435456) % 268435456;
      return c;
    },
  ...
  g.tM = g.TW.extend({
    ...
    jr: function () {
      if (!this.Jza() && (this.vL(), this.$oa(), this.map)) {
        var a = this,
          b = function () {
            a.map.camera = a.W3();
    ...
    Wo: function () {
      ...
      return g.a.eg() - this.Yga > a;
    },
    vL: function () {
      var a = this.get("centerCoords"),
        b = this.get("pitch"),
        c = this.get("rotation"),
        d = new g.Dc().i9(-a.x + g.a.ec.x, -a.y + g.a.ec.y, 0);
      this.ena = { x: a.x - g.a.ec.x, y: a.y - g.a.ec.y };
      a = new g.Dc().Tz(180 - b, 1, 0, 0);
      this.O7 = new g.Dc().set(a);
    ...
    Jza: function (a) {
      ...
      this.uz = this.qn / 10;
      this.NI = 50 * this.qn;
      this.Joa = (this.qn - this.uz) / (this.NI - this.uz);
      this.Me.f9(a, c, this.uz, this.NI);
    ...
    tD: function () {
      ...
      if (b !== this.Z7) {
        ...
        d.rotation =
          (a.get("rotateEnable") && parseInt(this.get("rotation"))) || 0;
    ...
    zg: function (a, b, c) {
      var d;
      this.map
        ? ((this.map.C = !0), (d = this.map.getSize(!0)), (this.map.C = !1))
        : (d = this.get("size"));
      ...
      a = f.Bh(d).elements;
      c = (e[2] - (-c || 0)) / (e[2] - a[2]);
      if (0 > a[2] || 0 > c || (b && c > 2.5 * this.Joa)) return null;
      b = e[0] - c * (e[0] - a[0]);
      c = e[1] - c * (e[1] - a[1]);
    ...
    P6: function (a) {
      for (
        var b = this.get("centerCoords"),
          ...
          m = l.elements,
          n = new g.H(0, 0),
          p = g.Dc.multiply(this.Me, this.dc),
          q = 0,
          r = a.length;
        q < r;
        q++
        ...
        if (a[q]) {
          a[q].concat
            ? ((n.x = a[q][0]), (n.y = a[q][1]), (n.z = -a[q][2] || 0))
            : ((n.x = a[q].x), (n.y = a[q].y), (n.z = -a[q].z || 0));
    ...
    kAa: function (a) {
      ...
      b = new g.H(
        ((a.elements[0] + 1) / 2) * b.width,
        ((-a.elements[1] + 1) / 2) * b.height
      );
      b.z = a.elements[2];
      return b;
    },
  ...
  g.Sb.Ib({
    x2: function (a, b, c) {
      var d = this;
      d.kF
        ? (clearTimeout(d.kF), (d.kF = null))
        : (d.qa("zoomstart", { zoom: a }), d.r("zoomstart"));
      ...
      if (e !== a) {
        ...
        c = function (c) {
          ...
          c === a &&
            ...
            h && !this.kF && (this.qa("zoomchange"), this.qa("zoomend")),
            this.r("zoomend"),
            k && this.r("moveend"),
            (this.Wf = null));
        };
    ...
    YK: function (a, b, c, d) {
      ...
      if (f || h) {
        if (
          !this.D.view.lm().contains(e) ||
          (f && "3D" !== this.D.view.type && (g.l.ba || g.l.Ve))
        )
          c = !0;
        if (c)
          f &&
            (b || (this.r("zoomstart"), this.qa("zoomstart")),
            this.set("zoom", a),
            this.qa("zoomchange"),
            this.qa("zoomend"),
            this.r("zoomend")),
            h &&
              (k || d || (this.qa("movestart"), this.r("movestart")),
            ...
            0.02 > b
              ? (this.Hd && (this.Hd.stop(), (this.Hd = null)),
                ...
                h &&
                  ...
                  this.r("moveend", { S5: d })),
                this.set("targetLevel", null))
              : (f && this.set("zoom", a - l * b),
                h &&
                  ((b = e.bb(m.Pd(b)).toFixed(3)),
  ...
  g.q.Zb = g.da.extend({
    ...
    opacityChanged: function () {
      ...
      if ((a = this.Ob))
        if (a.length) for (var b = 0; b < a.length; b += 1) this.IU(a[b]);
        else this.IU(a);
      this.e &&
        this.e.D &&
        "3D" == this.e.D.view.type &&
        this.set("display", 0);
    },
    zn: function () {
    ...
    cJ: function () {
      ...
      if (a) {
        if (a instanceof g.pe) {
          ...
          a instanceof g.Xf
            ? (this.I = [a.kc.x, a.kc.y, a.Xd.x, a.Xd.y])
            : a instanceof g.QF &&
              "3D" === this.S.Vf &&
              ((b = a.path[1]),
              (d = this.e.Cb(a.path[0])),
              (e = this.e.Cb(b)),
              (this.I = [d.x, d.y, e.x, e.y, a.U8, a.height]));
        return this.I;
      }
      return null;
    },
    ...
    return function () {
      function c() {
        ...
        for (a = f.length - 1; 0 <= a; a -= 1)
          (h = f[a].apply(this, arguments)), void 0 !== h && (b = h);
        return b;
      }
      c.TF = {};
      c.P1 = a;
  ...
  g.pg = g.da.extend({
    ...
    FHa: function (a) {
      this.Kp !== a && (this.Kp = a | 0) && this.z1(this.Kp);
    },
    Nd: function (a) {
      return !!this.e[a];
    },
    ...
    set: function (a, b) {
      ...
      c
        ...
        : ((c = new g.pg.vr(a, b)),
          ...
          this.vB(c),
          (this.count += 1),
          this.count > this.Kp && this.z1(this.Kp));
    },
    Cw: function (a) {
      this.remove(a);
    },
    ...
    forEach: function (a, b) {
      for (var c = this.dd.next; c !== this.dd; c = c.next)
    ...
    push: function (a) {
      a = new g.pg.vr("", a);
      0 === this.count
        ? ((this.dd.Ia = null), (a.Ia = this.dd), (this.dd.next = a))
        : ((this.kC.next = a), (a.Ia = this.kC));
      this.count += 1;
      this.kC = a;
    },
    yza: function (a) {
      a = new g.pg.vr("", a);
      0 === this.count
        ? ((this.dd.Ia = null), (a.Ia = this.dd), (this.kC = this.dd.next = a))
        : ((this.dd.next.Ia = a),
          (a.next = this.dd.next),
          (a.Ia = this.dd),
          (this.dd.next = a));
    ...
    Cua: function () {
      if (this.count) {
        ...
        var a = this.dd.next;
        a.next
          ? ((a.next.Ia = this.dd), (this.dd.next = a.next))
          : ((this.dd.next = null), (this.kC = this.dd.Ia = null));
        a.next = null;
        a.Ia = null;
        return a.value;
      }
    ...
    pop: function () {
      return this.s0(this.dd.Ia);
    },
    BY: function (a) {
      if (this.e.hasOwnProperty(a))
        return (a = this.e[a]), this.WF && (a.remove(), this.vB(a)), a;
    },
    vB: function (a) {
      this.WF
        ? ((a.next = this.dd.next),
    ...
    z1: function (a) {
      if (!(this.count <= a || this.count < 2 * this.EB.length)) {
        for (
          var b = this.WF ? this.dd.Ia : this.dd.next,
            c = {},
            d = 0,
            e = this.EB.length;
          d < e;
        ...
        for (
          ...
          b &&
          this.count > a &&
          ((d = this.WF ? b.Ia : b.next),
          b.key && !c[b.key] && this.WB(b) && this.lK(b.value),
          (b = d),
          b !== this.dd && b !== this.kC);
  ...
  g.yF = g.da.extend({
    ...
    QM: function (a) {
      a &&
        this.Mn.count >= this.R2 &&
        ((a = this.Mn.dd.Ia.value),
        a.rn && (this.Mn.remove(a.url), this.kX(a)));
      for (; this.Pq.count && !(this.Mn.count >= this.R2); )
        this.lea(this.Pq.shift());
    },
    Zga: function () {
      if (!this.UX) {
        this.UX = !0;
    ...
    lea: function (a) {
      ...
      b.complete
        ...
        : (this.Mn.set(a.url, a),
          ...
          (b.onerror = Rc(a, !1, !0)),
          (b.onabort = Rc(a, !1)),
          (a.Gya = setTimeout(Rc(a, !1, !0), this.timeout)));
    },
    kX: function (a) {
    ...
    oz: function (a, b, c, d, e) {
      var f = this.Mn.get(a);
      if (f && f.rn) (f.rn = !1), (f.Nc = b), (f.jR = c);
      else {
        f = new Qc(a, b, c);
        f.Tsa = d;
        f.key = e;
    ...
    Eta: function (a, b, c) {
      var d = this.Mn.get(a);
      if (d && d.rn) (d.rn = !1), (d.Nc = b), (d.jR = c);
      else {
        d = new Qc(a, b, c);
        d.kqa = !0;
    ...
    clear: function (a) {
      ...
      this.Pq.clear();
      if (a) for (; 0 < this.Mn.length; ) (a = this.Mn.pop()), this.kX(a);
      else
  ...
  g.q.mb = g.q.Zb.extend({
    A: function (a, b, c, d, e) {
      ...
      this.jL = c;
      this.X("reload", a);
      a.Psa ? this.X("createTile", a) : this.X("tileFun", a);
      this.gf = d;
      this.qS = e;
    },
    ...
    tileFunChanged: function () {
      ...
      this.Do = function (b, c, d) {
        ...
        if (!b.Ks || b.Ks.rn)
          (b.loaded = !1),
            (b.Ks = ("3D" === this.e.D.view.type ? g.rm.Eta : g.rm.oz).call(
              g.rm,
              e,
              function (a) {
                b.Ks = null;
    ...
    ne: function () {
      ...
      this.S.Osa && (a = [Math.min(a[0], 18), Math.min(a[1], 18)]);
      return {
  ...
  g.q.hd = g.q.Zb.extend({
    ...
    qa: function (a, b) {
      var c = {
        type: a,
        data: "mouseout" === a ? this.Wga || null : b.uu.ib,
        target: this.S,
        originEvent: b.zT,
      };
      this.Wga = "mouseout" === a ? null : b.uu.ib;
      this.S.r(a, c);
    },
    sc: function (a) {
      this.qa(a.type, a);
    ...
    ira: function (a) {
      if ("geojson" === a) return new g.xaa({ map: this.map });
      ...
      if (a) {
        ...
        if (a.rules) {
          for (var b = a.rules, d = 0, e = b.length; d < e; d += 1) {
            for (
              var f = [], h = b[d].symbolizers, k = 0, l = h.length;
              k < l;
              k += 1
            )
              h[k].fill && (f[k] = new g.style.Og.hW(h[k].fill)),
                h[k].stroke && (f[k] = new g.style.Og.MW(h[k].stroke));
            h = f;
            b[d].gL = h;
            b[d] = new g.style.pba(b[d]);
          }
          c.rules = b;
        }
        if (a.symbolizers) {
          ...
          for (d = b.length; a < d; a += 1)
            b[a].fill && (b[a] = new g.style.Og.hW(b[a].fill)),
              b[a].stroke && (b[a] = new g.style.Og.MW(b[a].stroke));
          c.gL = b;
        }
        a = new g.oM(c);
      } else a = new g.oM({});
    ...
    rwa: function (a) {
      "px" === a.target.get("unit")
        ? ((this.Bf = Math.max(a.ul, this.Bf)),
          (this.jg = Math.max(a.ul, this.jg)))
        : a.ul > this.Ps &&
          ((this.Ps = a.ul), (this.rz = this.Ps / this.map.D.nj.oq(20)));
    },
    QH: function (a) {
      this.gm.add(a);
      if (!this.YC && !this.S.Aj) {
        if (0 === a.name.indexOf("circle") || 0 === a.name.indexOf("ellipse")) {
          a.h("rad", this.rwa, this);
          var b = a.get("radius");
          b.length && (b = Math.max.apply(null, b));
          "px" === a.get("unit")
            ? ((this.Bf = Math.max(b, this.Bf)),
              (this.jg = Math.max(b, this.jg)))
            : this.Ps
            ? b > this.Ps &&
              ((this.Ps = b), (this.rz = this.Ps / this.map.D.nj.oq(20)))
            : ((this.Ps = b), (this.rz = this.Ps / this.map.D.nj.oq(20)));
        }
        b = a.get("strokeWeight") || 0;
        if (!this.sz || b > this.sz) this.sz = b;
      }
      this.eya || a.X("feature", this, !0);
    },
    ey: function (a) {
      this.om = !0;
    ...
    GEa: function (a) {
      var b,
        c = this.get("style"),
        d = a.vl;
      c instanceof g.oM || (c = this.Qva(c));
      if (d && 0 < d.length) b = c.V2(d, a);
      else {
        if (c.O8.length || c.vl.length) b = c.woa(a);
        b || (b = a.Lqa());
      }
      return b;
    },
    ...
    featureChanged: function (a) {
      ...
      var b = a.target,
        c = b.fc();
      0 !== this.gm.Qqa([g.a.zb(b)]).length &&
        (this.gm.remove(b, a.Pv), c && !a.Poa && this.gm.add(b));
    },
    q8: function (a) {
      this.om = !0;
      for (var b, c = 0, d = a.length; c < d; c += 1)
        (b = a[c]), (b.W.Pv = null), b.vs(!0), b.yl("feature");
    },
    KHa: function (a, b) {
      return a[1].zIndex === b[1].zIndex
        ? g.a.zb(a[1]) - g.a.zb(b[1])
        : a[1].zIndex - b[1].zIndex;
    },
    aya: function (a, b) {
      return a[2] - b[2];
    },
    ...
    bm: function (a) {
      return this.YC
        ? new g.M.Le.Hl(this, a)
        : "c" === this.map.get("overlayRender") && g.M.canvas.Hl
        ? new g.M.canvas.Hl(this, a)
        : g.M.ce.Hl && "d" === this.map.get("overlayRender")
        ? new g.M.ce.Hl(this, a)
        : null;
    },
  });
  g.q.hd.Ib({
  ...
  g.q.raa = g.da.extend({
    ...
    add: function (a) {
      ...
      this.sq[b] ||
        ...
        (this.sq[b] = a),
        c &&
          !g.I.hb(c.Md(), [Infinity, Infinity, -Infinity, -Infinity]) &&
          this.RT.Is(c.Md(), a));
    },
    AEa: function () {
      return this.sq;
    ...
    remove: function (a, b) {
      ...
      this.sq[c] &&
        ((this.sq[c] = null),
        d &&
          ((c = "undefined" !== typeof b ? b : d.Md()), this.RT.remove(c, a)));
    },
  });
  g.Mk = g.da.extend({
    A: function (a) {
      this.F6 = "undefined" !== typeof a ? a : 6;
      this.YJ = Math.floor(this.F6 / 2);
      ...
      do {
        ...
        for (var h = f.length - 1; 0 <= h; h -= 1) {
          ...
          var l = g.Mk.Vz(k.I[2] - k.I[0], k.I[3] - k.I[1], k.Kb.length + 1),
            k = g.Mk.Vz(
              (k.I[2] > a.I[2] ? k.I[2] : a.I[2]) -
                (k.I[0] < a.I[0] ? k.I[0] : a.I[0]),
              (k.I[3] > a.I[3] ? k.I[3] : a.I[3]) -
                (k.I[1] < a.I[1] ? k.I[1] : a.I[1]),
              k.Kb.length + 2
            );
      ...
      if (0 === b.Kb.length) (b.I = g.I.eb(a.I)), b.Kb.push(a);
        ...
        do {
          ...
          if ("undefined" !== typeof e.We || "undefined" !== typeof e.Kb || f) {
            ...
            if (c.Kb.length <= this.F6)
              if (0 < d.length) e = { I: g.I.eb(c.I) };
              else break;
            else
              (e = f = this.sta(c.Kb)),
                1 > d.length && (c.Kb.push(f[0]), d.push(c), (e = f[1]));
          } else g.I.extend(c.I, e.I), (e = { I: g.I.eb(c.I) });
        } while (0 < d.length);
      }
    },
    sta: function (a) {
      for (var b = this.Vva(a); 0 < a.length; ) this.Wva(a, b[0], b[1]);
      return b;
    },
    Vva: function (a) {
      for (
        var b = a.length - 1, c = 0, d = a.length - 1, e = 0, f = a.length - 2;
        0 <= f;
        f -= 1
      ) {
        var h = a[f];
      ...
      Math.abs(a[b].I[2] - a[c].I[0]) > Math.abs(a[d].I[3] - a[e].I[1])
        ? b > c
          ? ((b = a.splice(b, 1)[0]), (c = a.splice(c, 1)[0]))
          : ((c = a.splice(c, 1)[0]), (b = a.splice(b, 1)[0]))
        : d > e
        ? ((b = a.splice(d, 1)[0]), (c = a.splice(e, 1)[0]))
        : ((c = a.splice(e, 1)[0]), (b = a.splice(d, 1)[0]));
      return [
        { I: g.I.eb(b.I), Kb: [b] },
        { I: g.I.eb(c.I), Kb: [c] },
      ];
    ...
    Wva: function (a, b, c) {
      for (
        var d = g.Mk.Vz(b.I[2] - b.I[0], b.I[3] - b.I[1], b.Kb.length + 1),
          e = g.Mk.Vz(c.I[2] - c.I[0], c.I[3] - c.I[1], c.Kb.length + 1),
          f,
          h,
          k,
          l = a.length - 1;
        ...
        var m = a[l],
          n = [
            b.I[0] < m.I[0] ? b.I[0] : m.I[0],
            b.I[2] > m.I[2] ? b.I[2] : m.I[2],
            b.I[1] < m.I[1] ? b.I[1] : m.I[1],
            b.I[3] > m.I[3] ? b.I[3] : m.I[3],
          ],
          n = Math.abs(g.Mk.Vz(n[1] - n[0], n[3] - n[2], b.Kb.length + 2) - d),
          m = [
            c.I[0] < m.I[0] ? c.I[0] : m.I[0],
            c.I[2] > m.I[2] ? c.I[2] : m.I[2],
            c.I[1] < m.I[1] ? c.I[1] : m.I[1],
      ...
      d = a.splice(h, 1)[0];
      b.Kb.length + a.length + 1 <= this.YJ
        ? (b.Kb.push(d), g.I.extend(b.I, d.I))
        : c.Kb.length + a.length + 1 <= this.YJ
        ? (c.Kb.push(d), g.I.extend(c.I, d.I))
        : (k.Kb.push(d), g.I.extend(k.I, d.I));
    },
    remove: function (a, b) {
      var c = [];
      c[0] = { I: a };
      ...
      if (!1 === c[1]) {
        var d = 0,
          e = [];
        do (d = e.length), (e = e.concat(this.t8.apply(this, c)));
        while (d !== e.length);
        return e;
      }
      return this.t8.apply(this, c);
    },
    t8: function (a, b, c) {
      var d = [],
        e = [],
      ...
      do {
        ...
        if ("undefined" !== typeof b)
          for (; 0 <= k; ) {
            ...
            if (g.I.$g(a, l.I))
              if (
                (b && "undefined" !== typeof l.We && l.We === b) ||
                (!b && ("undefined" !== typeof l.We || g.I.S2(a, l.I)))
              ) {
                "undefined" !== typeof l.Kb
                  ? ((f = this.Pz(l, !0, [], l)), c.Kb.splice(k, 1))
                  : (f = c.Kb.splice(k, 1));
                g.Mk.aU(c);
                b = void 0;
                ...
                "undefined" !== typeof l.Kb &&
                  (e.push(k), d.push(c), (c = l), (k = l.Kb.length));
            k -= 1;
          }
          ...
          k = 0;
          for (l = h.length; k < l; k += 1) this.C5(h[k], c);
          h.length = 0;
          0 === d.length && 1 >= c.Kb.length
            ? ((h = this.Pz(c, !0, h, c)),
              (c.Kb.length = 0),
              d.push(c),
              e.push(1))
            : 0 < d.length && c.Kb.length < this.YJ
            ? ((h = this.Pz(c, !0, h, c)), (c.Kb.length = 0))
            : (h = void 0);
        } else g.Mk.aU(c);
      } while (0 < d.length);
      return f;
          ...
          if (g.I.$g(a.I, m.I))
            if ("undefined" !== typeof m.Kb) k.push(m.Kb);
              ...
              if (b) c.push(m);
                ...
                (m = m.We),
                  "undefined" !== typeof f ? (h[g.a.zb(m)] = m) : c.push(m);
        }
      } while (0 < k.length);
  ...
  g.B.Fh = g.da.extend({
    ka: [g.va, g.$e],
    Ava: ["position", "altitude", "visible", "clickable", "bubble"],
    A: function (a, b) {
      this.map = b;
      this.bf(this.Ava, a);
      this.X("zIndex", a);
    ...
    clickableChanged: function () {
      this.get("clickable") ? this.HM() : this.B1();
    },
    Nca: function () {
      this.get("clickable") && this.HM();
    ...
    eu: function (a) {
      ...
      if ("2D" == b) {
        ...
        "3D" == b &&
          ...
          a.Of.bb(this.e6),
          (this.gg = a.Db),
          "function" === typeof this.tz && this.tz(b, c, e),
          (this.f6 = a.Ta),
          (this.e6 = a.Of),
          this.qa("dragging", a));
    },
    ...
    Ut: function (a, b) {
      ...
      if (e)
        ...
        for (e = 0, f = a.length; e < f; e++)
          (h = c.Cb(a[e])), (h.x += b[0]), (h.y += b[1]), d.push(c.Qd(h));
      return d;
    },
  });
  g.B.wb = g.B.Fh.extend({
    ...
    animationChanged: function () {
      this.Hn &&
        (this.Hn.stop(),
        this.set("AnimationOffset", this.EO),
        (this.Hn = null));
      var a = this.get("animation");
      a &&
        "AMAP_ANIMATION_NONE" !== a &&
        ("AMAP_ANIMATION_DROP" === a ? this.TN(!0, "in", 100) : this.TN());
    },
    sg: function () {
    ...
    raiseOnDragChanged: function () {
      this.get("raiseOnDrag")
        ? (this.h("dragstart", this.D0, this),
          this.h("dragging", this.sg, this),
          this.h("dragend", this.pY, this))
        : (this.G("dragstart", this.D0, this),
          this.G("dragging", this.sg, this),
          this.G("dragend", this.pY, this));
    },
    ap: function (a) {
      var b = this.get("position");
      a = this.map.Cb(b).add(a.Pd(Math.pow(2, 20 - this.map.get("zoom"))));
      b instanceof g.U
        ? this.set("position", this.map.Qd(a))
        : this.set("position", a);
    },
    tz: function (a, b) {
    ...
    $ma: function () {
      ...
      e = a
        ? this.i2(a, c)
        : this.WP(this.get("icon"), function () {
            f.L && f.L.fa
              ? (g.l.Ai && g.a.iepngFix(e), f.offsetChanged(), f.uL())
              : f.map && f.map.set("display");
          });
      this.set("contentDom", e, !0);
      b && ((a = this.o2(b, c)), this.set("shadowDom", a, !0));
    ...
    Hu: function () {
      ...
      if (this.map && a && !this.L) {
        ...
        this.X("coords", a, !0);
        a.bf(
          "offset textAlign verticalAlign isTop zIndex params noSelect".split(
            " "
          ),
          this
        );
    ...
    offsetChanged: function () {
      ...
      if (this.map)
        if (this.L && this.L.fa) {
          ...
          "2D" == c
            ? ((c = this.map.Cb(this.get("position"))),
              (c = c.bb(this.L.Na).nd(Math.pow(2, 20 - this.map.get("zoom")))),
              this.L.fa &&
                (this.L.fa.NB && this.L.fa.parentNode !== this.L.fa.NB
                  ? this.map.set("display")
                  : a(c)))
            : "3D" == c &&
              ((c = this.get("position")),
              (c = this.map.Ns(c, this.get("altitude"))),
              this.L.fa &&
                (this.L.fa.NB && this.L.fa.parentNode !== this.L.fa.NB
                  ? this.map.set("display")
                  : a(c)));
    ...
    positionChanged: function () {
      if (this.L) {
        ...
        this.map && ((this.L.iba = !0), this.offsetChanged());
      }
    },
    ...
    UF: function () {
      this.L &&
        ((this.L.Xj = null),
        (this.L.se = !0),
        this.map && ((this.map.vd.nm = !0), this.map.set("display")));
    },
    contentChanged: function () {
      if (this.L) {
        this.L.Xj = null;
        this.map.vd.nm = !0;
        -1 === g.a.indexOf(this.map.vd.bh, this.L) &&
          this.map.vd.bh.push(this.L);
        ...
        this.L.fa
          ? (g.l.Ai && g.a.iepngFix(a),
            this.L.fa.appendChild(a),
            (this.L.Vg = a),
            this.offsetChanged(),
            this.uL())
    ...
    iconChanged: function () {
      if (this.L && !this.get("content")) {
        ...
        this.L.fa &&
          this.get("contentDom") &&
          this.L.fa.removeChild(this.get("contentDom"));
        var a = this.get("icon");
        this.get("offset");
        var b = this,
          c = this.WP(a, function () {
            b.L && b.L.fa
              ? (g.l.Ai && g.a.iepngFix(c), b.offsetChanged(), b.uL())
              : b.map && b.map.set("display");
          });
    ...
    shadowChanged: function () {
      if (this.L) {
        ...
        this.L.fa &&
          a &&
          a.parentNode === this.L.fa &&
          this.L.fa.removeChild(a);
    ...
    titleChanged: function () {
      this.L &&
        this.L.Vg &&
        "string" === typeof this.get("title") &&
        this.L.Vg &&
        this.get("title") &&
        (this.L.Vg.title = this.get("title"));
    },
    uL: function (a, b) {
      a = a || this.get("label");
    ...
    labelChanged: function (a) {
      ...
      if (this.L && this.L.fa) {
        ...
        a &&
          ...
          ((c = ""),
          a.content &&
            ((c = this.XP(a.content)), b.appendChild(c), this.uL(a, c)),
          this.set("labelDom", c));
      } else
        a && a.content
          ? this.set("labelDom", this.XP(a.content), !0)
          : this.set("labelDom", null);
    },
    isTopChanged: function () {
      var a = this.map.vd.lL,
        b = this.get("isTop"),
        c = this.get("zIndex");
      a
        ? a === this
          ? this.L &&
            this.L.fa &&
            ((this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 : c),
            (this.map.vd.lL = b ? this : null))
          : (a.L &&
              a.L.fa &&
              (a.L.fa.style.zIndex = b ? a.get("zIndex") : this.map.vd.fr + 10),
            this.L &&
              this.L.fa &&
              (this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 : c),
            (this.map.vd.lL = b ? this : a))
        : ((this.map.vd.lL = this),
          this.L &&
            this.L.fa &&
            (this.L.fa.style.zIndex = b ? this.map.vd.fr + 10 : c));
    ...
    visibleChanged: function () {
      this.L &&
        this.L.fa &&
        (this.get("visible") && !this.Mb.get("outOfZooms")
          ? (this.L.fa.style.display = "block")
          : (this.L.fa.style.display = "none"));
    },
    rva: function () {
      this.visibleChanged();
    },
    ...
    zIndexChanged: function () {
      ...
      this.L &&
        this.L.fa &&
        (this.L.fa.style.zIndex = this.get("isTop")
          ? this.map.vd.fr + 10
          : this.get("zIndex"));
    },
    opacityChanged: function () {
      ...
      a
        ? ("string" === typeof a
            ...
            : ((c = a.get("image")),
              ...
              (d = e.width),
              (e = e.height),
              f && ((l = f.width), (m = f.height))),
          (f = "string" !== typeof a ? a.get("imageOffset") : { x: 0, y: 0 }))
        : ((c = g.o.Ii + "/mark_bs.png"),
          (f = { x: 0, y: 0 }),
          (d = 19),
          (e = 33),
          (l = 19),
    ...
    moveChanged: function () {
      var a = this.get("move");
      if (!1 === a) return this.lya();
      void 0 !== a &&
        ("pause" === a.action
          ? this.Tva()
          : "[object Array]" === Object.prototype.toString.call(a.Of)
          ? a.Of &&
            ("resume" === a.action && this.PG
              ? this.moveTo(a.Of[a.Of.Mp || 0], a.speed, a.yb)
              : (this.PG && this.r("movestop"),
                (a.Of.Mp = 0),
                this.set("position", a.Of[0]),
                this.vua(a.Of, a.speed, a.yb, a.Cna)))
          : this.moveTo(a.Of, a.speed, a.yb, !0));
    },
    moveTo: function (a, b, c, d) {
      if (!(0 >= b)) {
        ...
        this.zh.Kq = function (b) {
          ...
          b.hb(a) &&
            (this.zh && (this.zh.stop(), (this.zh = null)),
            this.Mb.r("moveend", { target: this.Mb }),
            this.r("moveend"));
        };
        this.get("autoRotation") &&
          !g.l.Ve &&
          ((b =
            "2D" == (this.map.D.view.type || "2D")
              ? this.efa(e, a)
              : this.ffa(e, a)),
          this.set("angle", b));
        this.zh.On(this);
    ...
    vua: function (a, b, c, d) {
      ...
      function f() {
        a.Mp < a.length - 1
          ? ((a.Mp += 1), this.moveTo(a[a.Mp], b, c))
          : (this.qa("movealong"),
            d
              ? ((a.Mp = 0),
                this.set("position", a[0]),
                this.moveTo(a[a.Mp], b, c))
              : this.r("movestop"));
      }
    ...
    ffa: function (a, b) {
      ...
      var f = c.y - d.y,
        h = c.x - d.x;
      0 !== c.x - d.x
        ? ((e = Math.atan((c.y - d.y) / (c.x - d.x))),
          0 <= f && 0 > h
            ? (e = Math.PI + e)
            : 0 > f && 0 >= h
            ? (e = Math.PI + e)
            : 0 > f && 0 <= h && (e = 2 * Math.PI + e))
  ...
  g.B.Un = g.B.Fh.extend({
    ...
    Zg: function () {
      this.K &&
        (this.K.parentNode && this.K.parentNode.removeChild(this.K),
        (this.K = null));
    ...
    hg: function () {
      this.K &&
        (this.map.G("click", this.XBa, this),
        this.map.Ya.B.removeChild(this.K),
        (this.Up.ri = !1),
        (this.K = this.Up.De.map = null),
        this.map.G("movestart", this.bn, this),
        this.map.G("zoomstart", this.bn, this),
        this.map.G("click", this.bn, this),
        this.map.G("closeOverlays", this.bn, this),
        this.map.G("rotate", this.bn, this));
    },
    visibleChanged: function () {
      this.K &&
        (this.get("visible")
  ...
  g.B.Ze = g.B.Fh.extend({
    A: function (a, b) {
      arguments.callee.ma.apply(this, arguments);
      this.bf(
        "content contentDom position contentU altitude isCustom autoMove showShadow closeWhenClickMap size offset anchor".split(
          " "
        ),
        a
      );
    ...
    vt: function () {
      ...
      if (a) {
        ...
        if (b) {
          ...
          this.goa = d;
          a = g.f.create("a", this.rsa, "amap-info-close");
          a.innerHTML = "\u00d7";
          this.kQ = a;
          ...
          g.f.create(
            "div",
            c,
            g.l.Ve ? "amap-info-sharp-old" : "amap-info-sharp"
          );
    ...
    DV: function () {
      ...
      if (!a && b) {
        var a = this.NU,
          ...
          d = b.width;
        if (g.l.Ai || g.l.wv)
          (c = this.qh.childNodes[0].offsetHeight),
    ...
    Gm: function () {
      ...
      if (a && b && c) {
        ...
        if (this.kQ && d.childNodes[0]) {
          ...
          a > (this.get("size").height || d.clientHeight)
            ? (this.kQ.style.right = "20px")
            : (this.kQ.style.right = "5px");
        }
      }
    },
    Ida: function () {
    ...
    sX: function () {
      if (this.get("position") && this.get("autoMove") && this.qh) {
        for (
          var a = this.map,
            b = new g.zd(this.qh.offsetWidth, this.qh.offsetHeight),
            c = a
              .Ns(this.get("position"), this.get("altitude"))
              .add(this.Ida()),
            d = c.add(b.RE()),
            e = a.get("size"),
            f = a.Dqa(),
        ...
        0 > c.x || b.wj() > e.wj()
          ? (f = 20 - c.x)
          : e.wj() < d.x && (f = e.wj() - d.x - 25);
        0 > c.y || b.uj() > e.uj()
          ? (l = 5 - c.y)
          : e.uj() < d.y && (l = e.uj() - d.y - 15);
        f += h;
        l += k;
    ...
    Una: function () {
      this.get("closeWhenClickMap") &&
        (this.map.h("clickstart", this.F_, this, !1),
        this.map.h("clickend", this.E_, this, !1));
    },
    F_: function () {
      this.sf.ri &&
        ((this.sf.C = !0),
        this.sf.getIsOpen() && (this.sf.kL = !0),
        (this.sf.C = !1));
    },
    E_: function () {
      this.sf.ri &&
        (this.sf.kL && ((this.sf.C = !0), this.sf.close(), (this.sf.C = !1)),
        (this.sf.kL = !1));
    },
    hg: function () {
      this.Rc &&
        ...
        ((this.sf.kL = !1),
        this.get("closeWhenClickMap") &&
          (this.map.G("clickstart", this.F_, this),
          this.map.G("clickend", this.E_, this)),
        this.get("retainWhenClose")
          ? this.map.Nl.appendChild(this.Rc)
          : (this.Rc.parentNode === this.map.Ya.B &&
              this.map.Ya.B.removeChild(this.Rc),
            (this.sf.B = null)),
        (this.map = null),
        (this.sf.ri = !1),
        this.Mb.r("close", { type: "close", target: this.Mb }));
    },
    gCa: function () {
      if (!this.get("isCustom")) return this.qh.offsetWidth;
      for (
        var a = this.hi, b = a.firstChild, c = a.lastChild;
        b && c && b.style && c.style && b === c;

      )
        (a = b), (b = a.firstChild), (c = a.lastChild);
      a = g.f.$c(a, "width");
    ...
    positionChanged: function () {
      this.map && this.Rc && (this.Gm(), this.sX());
    },
    anchorChanged: function () {
      this.positionChanged();
    },
    ...
    Y8: function (a) {
      ...
      if (g.Aa.zp && this instanceof g.Aa.zp) {
        ...
        for (var e, c = 0; c < b; c += 1)
          if (((d = a[c]), (e = new g.Aa.VL(d)), (this.Rf[c] = e), 0 === c)) {
            if (0 === d.length) break;
            e.vq(d) || d.reverse();
  ...
  g.bi = g.da.extend({
    ...
    Zoa: function () {
      ...
      this.style = this.vl = this.vo = this.m6 = this.W = this.W.Oa = null;
      this.zl();
      this.ui();
    },
    xra: function () {
    ...
    FU: function (a) {
      a &&
        ((this.W = a), this.X("coords", a, !0), this.yB || this.VN) &&
        (a.X("radius", this),
        a.X("center", this),
        a.X("resolution", this),
    ...
    Lqa: function () {
      var a = this.fc(),
        b = [];
      a.zi() === g.Aa.Qe.GF || a.zi() === g.Aa.Qe.CF
        ? b.push(
            new g.style.Ce.Ec({
              fillColor: "#78cdd1",
              me: 0.2,
        ...
        : a.zi() === g.Aa.Qe.RL ||
          a.zi() === g.Aa.Qe.tW ||
          a.zi() === g.Aa.Qe.bM
        ? b.push(new g.style.Ce.yp({ color: "#888888", width: 1, zIndex: 10 }))
        : (a.zi() !== g.Aa.Qe.Xw && a.zi() !== g.Aa.Qe.cM) ||
          b.push(
            new g.style.Ce.di({
  ...
  g.M.Zb = g.da.extend({
          ...
          for (var e = f.bh, h = !0, k = [], l = 0; l < e.length; l += 1) {
            ...
            if (m)
              if (
                ...
                this.J &&
                m.parentNode.parentNode !== this.J.Nl &&
                "none" !== m.parentNode.style.display
              ) {
                var n = g.f.No(m),
                  m = n[0],
                  n = n[1];
                if (m && n) {
                  var p =
                    Math.max(
                      Math.abs(e[l].get("offset").x),
                      Math.abs(e[l].get("offset").y)
                    ) + Math.max(m, n);
            ...
            if (
              ...
              if (((k = h.fc()), k instanceof g.Aa.Ng))
                if (this.Aj) {
                  ...
                  l instanceof Array &&
                    (l =
                      "number" === typeof h.ib.style && l[h.ib.style]
                        ? l[h.ib.style]
                        : l[0]);
                  ...
                  (l = k.za),
                    ...
                    (k = k.get("radius")),
                    "px" === h.get("unit")
                      ? m.He(l) / Math.pow(2, 20 - this.zoom) < k && c.push(h)
                      : m.He(l) *
                          Math.cos((h.get("center").Q * Math.PI) / 180) <=
                          (k / this.Dq) * Math.pow(2, 20 - this.zoom) &&
                        c.push(h);
                else if ("AMap.Text" == h.Vp)
                  (l = h.get("params")),
                    l.visible &&
                      h.fa &&
                      g.f.JD(d, h.fa, "amap-markers") &&
                      c.push(h);
                else {
                ...
                k.Ud
                  ? k.Ud(a) && c.push(h)
                  : k.Gy &&
                    1.8 * k.Gy(a) <= h.get("strokeWeight") * this.T &&
                    c.push(h);
          this.Aj
            ? c.sort(function (a, b) {
            ...
            : c.sort(function (a, b) {
                return a.get("isTop")
                  ...
                  : b.get("isTop")
                  ? 1
                  : a.get("zIndex") > b.get("zIndex") ||
                    (a.get("zIndex") === b.get("zIndex") && a.hm > b.hm)
                  ? -1
                  : 1;
              });
          b(c, f);
    ...
    ID: function (a, b, c) {
      ...
      if ("circle" === a.w.type) {
        if (
          ((b = a.w.coords[0]),
          (c = a.w.coords[1]),
          Math.sqrt((d[0] - b) * (d[0] - b) + (d[1] - c) * (d[1] - c)) <=
            a.w.coords[2])
        )
          return !0;
      } else {
        if ("poly" === a.w.type)
          return (e = a.w.coords), (e = this.iI(e)), g.yd.Ud(d, e);
        if ("rect" === a.w.type)
          return (
            (e = a.w.coords),
            (a = e[0]),
    ...
    l4: function (a, b, c, d, e, f, h) {
      ...
      1 > f &&
        ("opacity" in a.style
          ? (k.push("opacity"), k.push(":"), k.push(f), k.push(";"))
          : 8 <= document.documentMode
          ? (k.push(
              "-ms-filter:'progid:DXImageTransform.Microsoft.Alpha(opacity="
            ),
  ...
  g.Y2 = {
    mD: function (a, b, c) {
      for (
        var d = null, e = null, f = 0, h = 0, k = 0, l = b.length;
        k < l;
        k++
      ) {
        var m = b[k];
    ...
    Ara: function (a) {
      ...
      c.Ub(a.nodes, function (a) {
        !1 !== a.value &&
          null !== a.value &&
          ((e[a.zoom] = g.o.Cc + "://" + a.value), d.push(a.zoom));
      });
      return function (a) {
        a = c.xb(a, 1);
    ...
    hra: function (a) {
      ...
      c.Ub(a.nodes, function (a) {
        null !== a.value &&
          !1 !== a.value &&
          ((e[a.zoom] = a.value), d.push(a.zoom));
      });
      return function (a) {
        a = c.xb(a, 1);
        if (void 0 === e[a]) {
          var k = b.mD(a, d, e);
          e[a] =
            f && "none" !== f && k.dK !== k.Iz && k.Nq !== k.YD
              ? c.K4(k.Nq, k.YD, (a - k.Iz) / (k.dK - k.Iz), f)
              : k.Nq;
        }
        return e[a];
      };
    ...
    Bqa: function (a, b, c) {
      ...
      e.Ub(a.nodes, function (a) {
        a.value &&
          ((h[a.zoom] = e.nma(a.value, c ? "rgba" : "webgl")), f.push(a.zoom));
      });
      return function (a) {
        var b = null;
        a = e.xb(a, 1);
    ...
    Tr: function (a, b) {
      for (var c = [], d = 0, e = a.length; d < e; d += 2) {
        var f = 0,
          f =
            "str" === b
              ? g.a.xb(parseInt(a.substr(d, 2), 16) / (0 === d ? 255 : 1), 3)
              : g.a.xb(parseInt(a.substr(d, 2), 16) / 255, 3);
        c.push(f);
      }
      return c.length
        ? (c.push(c.shift()), "str" === b ? "rgba(" + c.join(",") + ")" : c)
        : "";
    },
    H7: function (a, b, c, d) {
      var e = {},
        f = { visible: "visible", PU: "showLabel", xk: "showIcon" },
        h = [
          ...
          [
            "textStrokeColor",
            { yya: "textStrokeColor" },
            { zya: "textStrokeOpacity" },
          ],
          [
            "backgroundColor",
            { backgroundColor: "backgroundColor" },
            { wma: "backgroundOpacity" },
          ],
        ],
        k = { fontSize: "fontSize" },
      ...
      if (a.styles) {
        a = a.styles;
        this.Dz(e, a, f, this.tqa, { Isa: !0 });
        this.Dz(e, a, k, this.s4, { Xsa: !0 });
        this.Dz(e, a, l, this.s4, { Xsa: !0 });
        k = 0;
        for (l = h.length; k < l; k++) {
          var m = h[k];
          a[m[0]]
            ? this.Dz(e, a, m[1], this.Bqa, { Jsa: !0 })
            : this.Dz(e, a, m[2], this.hra);
        }
        a.texture &&
          (this.Dz(e, a, { Ja: "texture" }, this.Ara),
          (e.gd = []),
        ...
        for (n = h.length; f < n; f++) {
          var q = h[f],
            ...
            q = q[2][s];
          void 0 !== a[r]
            ? (e[p] = { canvas: this.Tr(a[r], "str"), Ye: this.Tr(a[r]) })
            : (e[s] = a[q]);
        }
        for (m in k) k.hasOwnProperty(m) && void 0 !== a[m] && (e[m] = a[m]);
        for (var u in l)
          l.hasOwnProperty(u) && void 0 !== a[u] && (e[u] = a[u]);
      ...
      if (a)
        for (var e in a)
          if (a.hasOwnProperty(e) && g.a.kk(a[e], "object")) {
            ...
            c && (h = c + ":" + e);
            if (f.detailedType)
              this.H7(f, b, h), this.ET(f.detailedType, b, h, f);
            else if (f.subType) this.ET(f.subType, b, h);
            else if (void 0 !== f.code)
              for (var k in d)
                d.hasOwnProperty(k) &&
                  !g.a.ka(["isDetailed", "detailedType", "styles"], k) &&
                  void 0 === f[k] &&
                  void 0 !== d[k] &&
                  (f[k] = d[k]);
          }
                    ...
                    h.hasOwnProperty(k) &&
                      ...
                      h[k].Ye
                        ? (b(h[k].Ye)
                            ...
                            : (c[d][f][k].Ye = h[k].Ye),
                          b(h[k].canvas)
                            ? (c[d][f][k].canvas = h[k].canvas(a))
                            : (c[d][f][k].canvas = h[k].canvas))
                        : b(h[k])
                        ? (c[d][f][k] = h[k](a))
                        : (c[d][f][k] = h[k]));
                } else c[d][f] = h;
    ...
    styleChanged: function () {
      if (this.e.D.Ci) {
        ...
        this.hl.SA ||
          ((this.hl = g.a.bind(this.hl, this)),
          (this.lq = g.a.bind(this.lq, this)),
          (this.hl.SA = !0));
        var b = g.a;
        if (a) {
          var c = {};
        ...
        var d, e, f, h, k;
        this.be &&
          ((d = this.be[30001] && this.be[30001][1]),
          (e = this.be[30001] && this.be[30001][2]),
          (f = this.be["00001"] && this.be["00001"][1]),
          (h = this.be["00001"] && this.be["00001"][2]),
          (k = this.be[50001] && this.be[50001][1]));
        var l,
          m,
          n,
          p,
        ...
        if (d) {
          ...
          if (d.visible) {
            ...
            s &&
              ((c = this.Dt(s, d.visible, "rgba(0, 0, 0, 0)")),
              (s = this.hl(
                b.qp(this.e.Ee.substr(1)),
                d.opacity,
                d.color,
                !0,
                a
              )),
              (l = this.Dt(s, d.visible)));
          }
          this.e.Pu = c;
        } else this.e.Pu = "";
        e &&
          e.visible &&
          ((m = this.hl(b.qp(this.e.MH.substr(1)), e.opacity, e.color, !0, a)),
          (m = this.Dt(m, e.visible)));
        f &&
          f.visible &&
          ((n = this.hl(b.qp(this.e.qu.substr(1)), void 0, f.color, !0, a)),
          (n = this.Dt(n, f.visible)),
          (p = this.Dt(n, f.visible)));
        h &&
          h.visible &&
          ((d = h.color),
          !d && f && f.color && (d = f.color),
          (p = this.hl(b.qp(this.e.qu.substr(1)), void 0, d, !0, a)),
          (p = this.Dt(p, h.visible)));
        k &&
          (k.visible
            ? ((q = this.hl(b.Zk(this.e.XF[0]), void 0, k.fillColor, !0, a)),
              (q = this.Dt(q, k.visible)),
              (r = this.hl(b.Zk(this.e.XF[1]), void 0, k.strokeColor, !0, a)),
              (r = this.Dt(r, k.visible)))
            : ((q = [1, 1, 1, 0]), (r = [1, 1, 1, 0])));
        this.nT && this.nT(l, m, n, [q, r], p);
        this.x$ ? this.x$(this.be) : this.set("display");
        delete this.em;
        this.AV(a);
      }
    },
    ...
    lq: function (a, b, c, d, e) {
      if (a) {
        ...
        if (c)
          return "function" === typeof c.canvas
            ? d
              ? c.canvas
              : c.canvas(e)
            : c.canvas;
    ...
    km: function (a, b, c, d, e) {
      ...
      if ((f = this.sD(b, e)))
        if (
          ("function" === typeof f.visible && !f.visible(e)) ||
          !1 === f.visible
        )
          h = "";
        else {
          ...
          else if (f.strokeColor || f.rb) (h = f.rb), (k = f.strokeColor);
    ...
    zs: function (a, b, c, d) {
      ...
      (e = this.sD(b, d)) &&
        (f =
          ("function" === typeof e.visible && !e.visible(d)) || !1 === e.visible
            ? ""
            : c(a, e.opacity, e.color, !1, d));
    ...
    Py: function (a, b, c, d, e, f) {
      ...
      var r = this.sD(d, f);
      r &&
        (("function" === typeof r.visible && !r.visible(f)) ||
        !1 === r.visible ||
        ("function" === typeof r.PU && !r.PU(f)) ||
        !1 === r.PU
          ? ((n = m = !1), (h = k = l = ""))
          : ((h = this.lq(a, r.wya, r.vya, !1, f)),
            (k = this.lq(b, r.zya, r.yya, !1, f)),
            (l = this.lq(c, r.wma, r.backgroundColor, !1, f)),
            (m = "function" === typeof r.xk ? r.xk(f) : r.xk),
            r.fontSize &&
              ((p =
                "function" === typeof r.fontSize ? r.fontSize(f) : r.fontSize),
              (p = 12 <= p ? p : 12),
              (p = 22 >= p ? p : 22)),
            p && g.l.Kc && (p *= 2)));
      f = !1;
    ...
    Oy: function (a, b, c, d, e) {
      ...
      var l = e || this.Hj;
      if ((f = this.sD(c, e)))
        ("function" === typeof f.visible && !f.visible(l)) || !1 === f.visible
          ? (h = k = "")
          : ((h = d(a, f.me, f.fillColor, !1, l)),
            (k = d(b, f.rb, f.strokeColor, !1, l)));
  ...
  g.M.canvas.Sb = g.M.Sb.extend({
    ...
    pc: function (a) {
      var b = this.e.S3();
      b && this.ZT !== b && this.e.D.Ci && (this.e.X8(b), (this.ZT = b));
      ...
      if (
        !this.Na ||
        1e4 < Math.abs(b.nb.x - this.Na.x) / this.T ||
        1e4 < Math.abs(b.nb.y - this.Na.y) / this.T
      )
        this.Na = b.nb;
      this.Na.x - b.nb.x < -g.a.Fa / 2
        ? (this.Na = new g.H(this.Na.x + g.a.Fa, this.Na.y))
        : this.Na.x - b.nb.x > g.a.Fa / 2 &&
          (this.Na = new g.H(this.Na.x - g.a.Fa, this.Na.y));
        ...
        if (l && l.g)
          if (
            ...
            var k = l.vj(),
              ...
              p,
              q = l.transform;
            if (!q || !k || (l.Di && !this.e.D.Ra))
              c[h].zj &&
                k.parentNode !== this.K &&
                (this.K.appendChild(k), (c[h].Ob = k));
            else {
              c[h].Ob = k;
              k.length || ((k = [k]), (q = [q]));
              for (var r = 0; r < k.length; r += 1)
                if (((n = k[r]), (p = q[r]), !p.bz)) {
                  ...
                  c[h].YC
                    ? (w.push("top:" + Math.floor(f / 2 + u) + "px"),
                      w.push("left:" + Math.floor(e / 2 + s) + "px"))
                    : n.Q5
                    ? (w.push("height:" + n.height * v + "px"),
                      w.push("width:" + n.width * v + "px"),
                      w.push("top:" + (f / 2 - u * v) + "px"),
                      w.push("left:" + (e / 2 - s * v) + "px"))
                    : (1 !== v &&
                        (w.push(
                          g.f.qt[g.f.qg] + "-origin:" + s + "px " + u + "px"
                        ),
                        w.push(
                          g.f.qt[g.f.qg] + ":scale3d(" + v + "," + v + ",1)"
                        )),
                      w.push("top:" + Math.floor(f / 2 - u) + "px"),
                      w.push("left:" + Math.floor(e / 2 - s) + "px"),
                      w.push("display:block"),
                      l.ll &&
                        (w.push("height:" + n.height + "px"),
                        w.push("width:" + n.width + "px")));
                  l.IJ ||
                    1 === m.opacity ||
                    "number" !== typeof m.opacity ||
                    w.push(g.f.u4(n, m.opacity));
      ...
      k = this.e.Ya.q;
      c = this.e.Ya.B;
      g.f.qg && "number" === typeof b.rotation && 0 !== b.rotation
        ? ((a.style[g.f.qg + "Origin"] = e / 2 + "px " + f / 2 + "px"),
          (a.style[g.f.qg] = "rotate(" + b.rotation + "deg)"),
  ...
  g.M.Ui = g.M.Zb.extend({
    A: function (a, b) {
      ...
      this.oa = new g.pg(c);
      var e = this;
      this.oa.lK.P1(function (a) {
        e.dB(a);
      });
      this.oa.zC = function (a) {
        return a.qb
          ? ((a.qb.Tg -= 1), 0 == a.qb.Tg && (a.Cv = !1), delete a.qb, !0)
          : a.Cv
          ? a.Tg
            ? !1
            : !0
    ...
    Jq: function () {
      ...
      this.Lc &&
        (this.Lc.G("tiles", this.dE, this),
        this.Lc.G("ack", this.cE, this),
        this.Lc.G("disable", this.aE, this),
        (this.Lc = null));
    ...
    fIa: function (a, b, c, d) {
      ...
      for (var f = 0; f < a.length; f += 1) {
        ...
        if (d) {
          if (
            ((k = c + "/" + k + "/" + h),
            (h = this.oa.get(k)) && "loaded" == h.status)
          )
            continue;
    ...
    OI: function (a, b) {
      ...
      if (this.g.wH) {
        var e,
          ...
          p = (function () {
            ...
            for (e = a.length - 1; 0 <= e; e -= 1)
              for (
                f = a[e], h = [], k = [], f.$T = h, f.Ov = k, l = f.length - 1;
                0 <= l;
                l -= 1
              )
                (m = f[l]),
                      ...
                      return function (e) {
                        ...
                        if (0 == p) {
                          for (e = a.length - 1; 0 <= e; e -= 1) {
                            ...
                            a[e] = l.$T;
                            if (l.Ov)
                              for (var m = l.Ov.length - 1; 0 <= m; m -= 1) {
                                var n = l.Ov[m];
                                n.status = "loaded";
                                n.loaded = !0;
                                n.Ba = !0;
        ...
        if ("object" === typeof p) return p.wL;
      } else b.call(this, a);
    },
    uw: function (a, b, c) {
    ...
    Gn: function (a) {
      ...
      if ((!this.lk || (!this.hf && !this.he)) && a.length)
        if (this.KK) this.bK = !0;
        else {
          for (var c = a.length - 1; 0 <= c; c -= 1) {
            var d = a[c];
            if (d.length)
              for (
                var e = Math.pow(2, 20 - d[0].ta.z), c = d.length - 1;
                0 <= c;
                c--
              ) {
                var f = d[c],
                ...
                if (10 > h.z) {
                  ...
                  k &&
                    ...
                    (f.Ba = !0),
                    (k.Tg += 1),
                    (f.cl = (h.x - k.ta.x) / Math.pow(2, h.z)),
                    d.splice(c, 1),
                    this.set("display", 0));
                }
                this.oa.set(f.key, f);
    ...
    jw: function (a, b) {
      if (a.length) {
        var c = this.nb.nd(this.Fd << (20 - a[0].ta.z)),
          d = Math.floor(c.x),
          e = Math.floor(c.y);
        a.sort(function (a, c) {
          var k = a.ta,
    ...
    ip: function (a, b) {
      ...
      this.oe = c.oe;
      this.gb =
        "AMap.MapBox" == this.g.S.CLASS_NAME
          ? Math.max(2, this.oe - g.o.Wn)
          : !1 === this.Ei && !this.g.qS && this.g.ja
          ? this.oe + 1
          : this.oe;
      ...
      this.Jw = c.T$ ? this.uy(c.T$, b.I) : null;
      var c = this.rk,
        d = this.Ha.L9,
        e = null,
      ...
      for (q = m.length - 1; 0 <= q; q -= 1)
        if (((k = m[q]), !(k.kx < b.opacity)))
          if (((p.z = k.ta.z), (p.x = k.ta.x), (p.y = k.ta.y), p.z === this.gb))
            s[p + ""] |= 16;
          else if (p.z < this.gb) {
            if (((s[p + ""] |= 64), this.$i))
              for (
                x = this.gb - p.z,
                  v = Math.max(c.Jc, p.x << x),
                  r = Math.min(c.Ic, ((p.x + 1) << x) - 1),
                  w = Math.max(c.hc, p.y << x),
                  t = Math.min(c.tc, ((p.y + 1) << x) - 1),
                  p.z = this.gb,
                  x = v;
                x <= r;
                x += 1
              )
                for (p.x = x, y = w; y <= t; y += 1)
                  (p.y = y),
                    (E = p + ""),
                    (s[E] |= 32),
                    (u[E] = u[E] ? Math.max(k.ta.z, u[E]) : k.ta.z);
          } else if (this.Zi)
            for (v = 1; p.z >= this.gb; ) {
              s[p + ""] |= v;
              v = p.x >> 1;
          ...
          (p.y = y),
            ...
            k.Ba
              ? ((k.fe = this.fe),
                this.xv(c, x, y) &&
                  (m.push(k),
                  this.Jl && (k.jd !== this.jd || 1 > k.kx) && (v = !0)))
              : ((q = !1),
                this.xv(c, x, y) && (v = !0),
                (k.status && !k.Je) ||
                  this.oe !== d ||
                  (this.Jw && !this.xv(this.Jw, x, y)) ||
                  l.push(k)),
            v && n.push(k);
          ...
          for (q = d.length - 1; 0 <= q; q -= 1)
            if (((x = d[q]), (v = s[x.key]), v & 7))
              for (v = x.ta.x << 1, w = x.ta.y << 1, x = 1; 0 <= x; x -= 1)
                for (p.x = v + x, y = 1; 0 <= y; y -= 1)
                  (p.y = w + y),
                    (E = p + ""),
                    (t = this.oa.sK(E)),
                    s[E] & 5 && t && t.Ba
                      ? ((t.KB = !0), (t.fe = this.fe), m.push(t), this.cu(t))
                      : n.push(new g.mb(p.eb()));
      ...
      if (!e && this.$i)
        for (
          x = !f.length || this.ll ? b.Za[0] : Math.max(b.Za[0], this.gb - 2),
            Math.max(x, this.gb - this.jha),
            r = this.gb - 1;
          n.length && r >= x;
          r -= 1
        ) {
          ...
          for (q = d.length - 1; 0 <= q; q -= 1)
            (k = d[q]),
              ...
              y[k.key] ||
                ((y[k.key] = 1),
                (v = !1),
                k.Ba && (!this.jja || s[k.key] & 64)
                  ? ((p.x = Math.min(
                      c.Ic,
                      Math.max(c.Jc, p.x << (this.gb - r))
                    )),
                    (p.y = Math.min(
                      c.tc,
                      Math.max(c.hc, p.y << (this.gb - r))
                    )),
                    (p.z = this.gb),
                    (E = p + ""),
                    "number" === typeof u[E] && k.ta.z > u[E]
                      ? (v = !0)
                      : (k.KB = !0),
                    (k.fe = this.fe),
                    m.push(k),
    ...
    KR: function (a, b) {
      for (
        var c = [],
          d = this.e.D.getCoordsBoundByZoom(a),
          d = this.uy(d, b, a),
          e = d.Jc;
        e < d.Ic;
        e++
  ...
  g.M.ce.Ui = g.M.Ui.extend({
    ...
    $v: function (a) {
      var b = Math.pow(2, a.P.zoom - this.Df),
        c = a.P.nb.bb(this.Ls).nd(this.ym);
      this.transform = {
    ...
    Nz: function (a, b) {
      ...
      this.wg &&
        ...
        ((c = this.g),
        (c.Ra = !0),
        c.Ld ? c.qa("renderComplete") : ((c.Ld = !0), c.qa("complete")));
    },
    pc: function (a, b) {
      this.up = a.up;
      this.hf = a.hf;
    ...
    Zv: function () {
      for (var a = this.Ob.childNodes, b = a.length - 1; 0 <= b; b -= 1)
        a[b] && a[b].jd !== this.jd && this.Ob.removeChild(a[b]);
    },
    sE: function (a, b) {
      ...
      for (d = a.length - 1; 0 <= d; d -= 1)
        if (((f = a[d]), f.length)) {
          ...
          for (var r = f.length - 1; 0 <= r; r -= 1) {
            ...
            u.y = g.a.xb(u.y, 1);
            var v = 1;
            if (!n.qY || (this.uX && n.jd !== b)) n.qY = this.currentTime;
            this.Jl && !n.KB
              ? ((v = Math.max(0, Math.abs(m.z - this.zoom) - 1)),
                (v = Math.min(
                  1,
                  (this.currentTime - n.qY) /
                    ((1 / Math.pow(1.32, v)) * this.ao)
                )),
                1 !== v && (this.ze = !0))
              : (n.KB = !1);
            n.jd = this.jd;
            ...
            n.Ba
              ? ((s = n.ld),
                !s &&
                  n.qb &&
                  n.qb.ld &&
                  ("CANVAS" === n.qb.ld.tagName
                    ? ((s = document.createElement("canvas")),
                      (s.width = n.qb.ld.width),
                      (s.height = n.qb.ld.height),
                      s
                        .getContext("2d")
                        .drawImage(n.qb.ld, 0, 0, s.width, s.height),
                      (n.ld = s),
                      (n.qb.Tg -= 1),
                      (n.qb = null),
                      (n.cl = 0))
                ...
                0 !== v &&
                  s &&
                  (this.l4(s, u.x, u.y, p, p, v, m.z),
                  s.parentNode !== this.Ob &&
                    (g.l.Ai &&
                      "overlayer" === this.g.get("type") &&
                      (s.style.display = "none"),
                    this.ev.appendChild(s)),
                  (s.jd = this.jd),
                  (n.oe = this.oe),
                  h.push(n)))
              : (n.fe = null);
  ...
  window.CanvasRenderingContext2D &&
    ((window.CanvasRenderingContext2D.prototype.DQ = function (a, b, c, d, e) {
      ...
      e.Fg = 0;
      for (
        var l = [], f = this.uI, m = 0, n = 0, p = !1, q = (h = 0);
        q < e.length;
        q += 1
      )
        (e.Fg += e[q]),
          (l[q] = { cD: e[q] * d, dD: e[q] * c, hz: (h += e[q]) }),
          (f -= e[q]),
          0 > f && !p && ((m = q), (n = -f), (p = !0));
      for (p = 0; n + p <= k; )
        n < e[m] ? ((f = n * d), (h = n * c)) : ((f = l[m].cD), (h = l[m].dD)),
          (a += f),
          (b += h),
    ...
    (window.CanvasRenderingContext2D.prototype.Foa = function (a, b, c, d) {
      ...
      d = (d[0] / e) * 2 * Math.PI;
      for (e = 0; e < f; e += 1)
        this.beginPath(), this.arc(a, b, c, e * h, e * h + d), this.stroke();
    }));
  g.M.Le.Hl = g.M.Ui.extend({
    ...
    wt: function (a, b) {
      ...
      if (
        !this.Na ||
        500 < Math.abs(this.ob.x - this.Na.x) / this.T ||
        500 < Math.abs(this.ob.y - this.Na.y) / this.T
      )
        c = !0;
      if (c || this.zoom << 0 !== this.zoom || this.Df !== this.zoom)
        (this.Na = this.ob), (this.Df = this.zoom);
    },
    mv: function (a) {
    ...
    pc: function (a, b) {
      ...
      c = c.yn(e);
      for (d in c)
        c.hasOwnProperty(d) && ((c[d].fe = this.fe), (c[d].m6 = this));
      this.Zv(c);
    ...
    Oe: function () {
      ...
      this.transform = {
        translate: this.Na.bb(this.ob).nd(this.T),
        scale: a,
        rotate: 0,
      };
    },
      ...
      for (f in a)
        if (a.hasOwnProperty(f)) {
          ...
          if ("AMap.Text" == h.Vp || "AMap.Marker" == h.Vp) {
            if (
              ((w = v = 0),
              k.parentNode !== this.ql && d && ((m = !0), (d[f] = h), (e = !1)),
              !m)
            ) {
          ...
          if (!m)
            if (h.se) {
              ...
              E.push("top:" + r + "px");
              E.push("left:" + q + "px");
              E.push("z-index:" + (l.X5 ? this.g.fr + 10 : l.zIndex));
              if (!g.l.Ve) {
                r = v;
                q = w;
                if ("AMap.Marker" == h.Vp) {
              ...
              if ((p = l.label) && p.content) {
                ...
                p.offset
                  ? ((r = r + p.offset.y + "px"), (q = q + p.offset.x + "px"))
                  : ((r += "px"), (q += "px"));
                l.style.top = r;
                l.style.left = q;
              }
          ...
          h.zoom = this.zoom;
          k.parentNode !== this.ql &&
            (g.l.Ai && g.a.iepngFix(k), c.appendChild(k));
          h.se = m;
          k.NB = this.ql;
        }
  ...
  Uc.ba || Xc.push("mouse");
  Uc.eL &&
    (Xc.push("vectorlayer", "overlay"),
    Uc.sp ? Xc.push("wgl") : Xc.push("cgl"));
  if (Vc) {
  ...
  if (Uc.Kv) {
    ...
    try {
      for (var Kc = 0, dd = Xc.length; Kc < dd; Kc++) {
        ...
        if (ed && ed.version === Oc.Fk)
          bd.push(ed.script), ed.css && cd.push(ed.css);
        else {
          bd = void 0;
          ad = !1;
          break;
  ...
  if (Wc) for (Kc = 0; Kc < Xc.length; Kc += 1) g.ub.SC(Xc[Kc]).status = 1;
  else (Oc.PJ = !1), jd();
  function kd() {
    for (
      var a = fa.getElementsByTagName("script"), b, c = 0;
      c < a.length;
      c += 1
    )
      if (0 === a[c].src.indexOf(Oc.Hb + "/maps?")) {
        b = a[c];
        break;
      }
  ...
  function jd() {
    ...
    kd()
      ? ld(a)
      : (fa.write(
          '<script crossorigin="anonymous" id="amap_plus_js" src="' +
            a +
  ...
  function ld(a) {
    ...
    b.src = a;
    b.id = "amap_plus_js";
    (a = fa.head || fa.getElementsByTagName("head")[0] || fa.body) &&
      a.appendChild(b);
  }
  function gd() {
    var a = cd.join("\n"),
    ...
    b.type = "text/css";
    -1 === Oc.Hb.indexOf("webapi.amap.com") &&
      (a = a.replace(/webapi.amap.com/gi, Oc.Hb.split("://")[1]));
    ...
    2 > c.childNodes.length
      ? c.appendChild(b)
      : c.insertBefore(b, c.childNodes[1]);
  }
  typeof _cssload_ == "function" &&
    _cssload_(
      "logo",
  ...
  "42ee35775cc64a4ae1784043c610d940",
  [115.423411, 39.442758, 117.514625, 41.060816, 116.405285, 39.904989],
